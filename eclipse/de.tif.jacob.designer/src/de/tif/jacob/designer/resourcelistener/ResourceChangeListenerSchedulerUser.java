 ...
 * 
 */
public class ResourceChangeListenerSchedulerUser extends AbstractResourceChangeListener
{
...
//     IPath DOC_PATH = new Path(JacobDesigner.getPlugin().getSelectedProject().getName()+"/java/jacob/scheduler/user");
     IPath DOC_PATH = getJavaSourcePath("jacob"+File.separator+"scheduler"+File.separator+"user");
     ...
     final IResourceDeltaVisitor visitor = new IResourceDeltaVisitor() 
     {
        public boolean visit(IResourceDelta delta) 
        {
           ...
           if (resource.getType() == IResource.FILE && 	"java".equalsIgnoreCase(resource.getFileExtension())) 
           {
             ...
             ScheduledJobUserModel model =jacob.getScheduledJobUserMode(name);
             if(model!=null)
