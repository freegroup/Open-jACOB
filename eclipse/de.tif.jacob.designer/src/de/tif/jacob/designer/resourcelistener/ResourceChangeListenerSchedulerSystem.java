 ...
 * 
 */
public class ResourceChangeListenerSchedulerSystem extends AbstractResourceChangeListener
{
  ...
  public void resourceChanged(IResourceChangeEvent event) 
  {
     ...
     IPath DOC_PATH = getJavaSourcePath("jacob"+File.separator+"scheduler"+File.separator+"system");
     ...
     final IResourceDeltaVisitor visitor = new IResourceDeltaVisitor() 
     {
        public boolean visit(IResourceDelta delta) 
        {
           ...
           if (resource.getType() == IResource.FILE && 	"java".equalsIgnoreCase(resource.getFileExtension())) 
           {
             ...
             ScheduledJobSystemModel model =jacob.getScheduledJobSystemMode(name);
             if(model!=null)
