 ...
 *
 */
public class UIDBInformLongTextModel extends UIInformLongTextModel implements UIDBLocalInputFieldModel
{
  public UIDBInformLongTextModel()
  {
    super();
  }

  protected UIDBInformLongTextModel(JacobModel jacob, UIGroupContainer container, UIGroupModel group, CastorGuiElement guiElement)
  {
  ...
  public IPropertyDescriptor[] getPropertyDescriptors()
	...
	public FieldModel getFieldModel()
	{
	  if(getCastor().getCastorGuiElementChoice().getLocalInputField().getTableField()==null)
	  {
	    ...
	    getCastor().getCastorGuiElementChoice().getLocalInputField().getLongTextInput().setInForm(true);
