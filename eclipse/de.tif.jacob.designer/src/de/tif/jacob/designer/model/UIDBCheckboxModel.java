 ...
 *
 */
public class UIDBCheckboxModel extends UICheckboxModel  implements UIDBLocalInputFieldModel
{
  public UIDBCheckboxModel()
  {
    super();
  }

  protected UIDBCheckboxModel(JacobModel jacob,  UIGroupContainer container, UIGroupModel group, CastorGuiElement guiElement)
  {
  ...
  {
    return FieldModel.DBTYPE_BOOLEAN;
  }
	...
	public String getError()
  {
    if(getFieldModel() == getFieldModel().getTableModel().NULL_FIELD)
      return "Checkbox ["+getName()+"] has not a valid reference to a column in the table ["+getFieldModel().getTableModel().getName()+"]";
    return null;
  }
