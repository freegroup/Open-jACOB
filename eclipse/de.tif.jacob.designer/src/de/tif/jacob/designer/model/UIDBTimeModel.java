 ...
 *
 */
public class UIDBTimeModel extends UITimeModel implements UIDBLocalInputFieldModel
{
  public UIDBTimeModel()
  {
    super();
  }

  protected UIDBTimeModel(JacobModel jacob, UIGroupContainer container,  UIGroupModel group, CastorGuiElement guiElement)
  {
	...
	public String getError()
  {
    if(getFieldModel() == getFieldModel().getTableModel().NULL_FIELD)
      return "Time input field ["+getName()+"] has not a valid reference to a column in the table ["+getFieldModel().getTableModel().getName()+"]";
    return null;
  }
