 ...
 *
 */
public class UIDBDateTimeModel extends UIDateTimeModel implements UIDBLocalInputFieldModel
{
  public UIDBDateTimeModel()
  {
    super();
  }

  protected UIDBDateTimeModel(JacobModel jacob, UIGroupContainer container, UIGroupModel group, CastorGuiElement guiElement)
  {
  ...
  {
    return FieldModel.DBTYPE_TIMESTAMP;
  }
  ...
  public String getError()
  {
    if(getFieldModel() == getFieldModel().getTableModel().NULL_FIELD)
      return "DateTime input field ["+getName()+"] has not a valid reference to a column in the table ["+getFieldModel().getTableModel().getName()+"]";
    return null;
  }
