 ...
 *
 */
public class UIDBPasswordModel extends UIPasswordModel implements UIDBLocalInputFieldModel
{
  public UIDBPasswordModel()
  {
    super();
  }

  protected UIDBPasswordModel(JacobModel jacob, UIGroupContainer container, UIGroupModel group, CastorGuiElement guiElement)
  {
	...
	public String getError()
  {
    if(getFieldModel() == getFieldModel().getTableModel().NULL_FIELD)
      return "Password input field ["+getName()+"] has not a valid reference to a column in the table ["+getFieldModel().getTableModel().getName()+"]";
    return null;
  }
