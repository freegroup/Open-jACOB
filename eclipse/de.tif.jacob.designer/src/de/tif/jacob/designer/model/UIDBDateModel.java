 ...
 *
 */
public class UIDBDateModel extends UIDateModel implements UIDBLocalInputFieldModel
{
  public UIDBDateModel()
  {
    super();
  }

  protected UIDBDateModel(JacobModel jacob, UIGroupContainer container,  UIGroupModel group, CastorGuiElement guiElement)
  {
  ...
  public String getError()
  {
    if(getFieldModel() == getFieldModel().getTableModel().NULL_FIELD)
      return "Date input field ["+getName()+"] has not a valid reference to a column in the table ["+getFieldModel().getTableModel().getName()+"]";
    return null;
  }
