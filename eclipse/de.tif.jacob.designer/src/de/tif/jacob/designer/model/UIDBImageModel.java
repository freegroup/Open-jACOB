 ...
 *
 */
public class UIDBImageModel extends UIImageModel implements UIDBLocalInputFieldModel
{
  public UIDBImageModel()
  {
    super();
  }

  protected UIDBImageModel(JacobModel jacob,  UIGroupContainer container, UIGroupModel group, CastorGuiElement guiElement)
  {
  ...
  public String getError()
  {
    if(getFieldModel() == getFieldModel().getTableModel().NULL_FIELD)
      return "Image field ["+getName()+"] has not a valid reference to a column in the table ["+getFieldModel().getTableModel().getName()+"]";
    return null;
  }
