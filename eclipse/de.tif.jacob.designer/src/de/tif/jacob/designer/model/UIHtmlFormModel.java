...
public class UIHtmlFormModel extends UIFormModel
{
  private final CastorHtmlForm castor;
  private UIHtmlGroupModel group;
  
  public UIHtmlFormModel(JacobModel jacob, String name)
  {
    super(jacob);
    this.castor = new CastorHtmlForm();
    ...
    this.group = new UIHtmlGroupModel(jacob, this);
    this.castor.addGroup(this.group.getCastor());
  }
  
  public UIHtmlFormModel(JacobModel jacob, CastorHtmlForm form)
  {
    super(jacob);
    this.castor=form;
    this.group = new UIHtmlGroupModel(jacob, this, form.getGroup(0));
  }
  ...
  {
    return "IHtmlFormEventHandler.java";
  }
  ...
  public CastorHtmlForm getCastor()
  {
    return this.castor;
  }
  ...
  public UIHtmlGroupModel getRenderGroup()
  {
    return group;
  }
