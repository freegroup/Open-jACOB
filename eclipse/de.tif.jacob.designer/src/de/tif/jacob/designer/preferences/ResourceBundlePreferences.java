...
/**
 */
public final class ResourceBundlePreferences
{
  /** Key group separator. */
  ...
  /** RBPreferences. */
  private static final Preferences PREFS = JacobDesigner.getPlugin().getPluginPreferences();

  /**
   * Constructor.
   */
  private ResourceBundlePreferences()
  {
    super();
  }
  ...
  public static String getKeyGroupSeparator()
  {
    return ".";
    /*
    String sep= PREFS.getString(KEY_GROUP_SEPARATOR);
    if(sep==null || sep.length()==0)
    {
      sep = "_";
      PREFS.setValue(KEY_GROUP_SEPARATOR,sep);
    }
    return sep;
    */
  }
