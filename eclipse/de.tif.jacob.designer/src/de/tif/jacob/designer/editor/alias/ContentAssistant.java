...
{
    public static SubjectControlContentAssistant createContentAssistant(Text input, TableAliasModel model) 
    {
      	TextContentAssistSubjectAdapter adapter = new TextContentAssistSubjectAdapter(input);
        final SubjectControlContentAssistant contentAssistant = new SubjectControlContentAssistant();

        IContentAssistProcessor processor = new ContentAssistProcessors(model);
