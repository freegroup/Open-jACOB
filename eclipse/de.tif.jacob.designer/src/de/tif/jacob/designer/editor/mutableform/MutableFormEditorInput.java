 ...
 * Comments
 */
public class MutableFormEditorInput implements IEditorInput, IPersistableElement, TreeSelectionObjectModelProvider
{
  private final UIMutableFormModel model;
  
  public MutableFormEditorInput(UIMutableFormModel model)
  {
    this.model = model;
  }
  ...
  {
    if (obj instanceof MutableFormEditorInput)
    {
      MutableFormEditorInput other = (MutableFormEditorInput) obj;
