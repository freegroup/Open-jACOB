 ...
 * Comments
 */
public class MutableFormEditor extends FormEditor implements PropertyChangeListener,  ISelectionProvider
{
  public static final String ID = "de.tif.jacob.designer.editor.mutableform.MutableFormEditor";

  List listeners = new ArrayList();
  ISelection theSelection = StructuredSelection.EMPTY;

  private MutableFormPropertiesPage page;
  private UIMutableFormModel model;
  
  /**
   *  
   */
  public MutableFormEditor()
  {
  }
  ...
  protected void addPages()
  {
    try
    {
      addPage( page=new MutableFormPropertiesPage(this));
    }
  ...
  public void init(IEditorSite site, IEditorInput input) throws PartInitException
  {
    ...
    model =((MutableFormEditorInput) input).getFormModel();
    setPartName( model.getName());
    setTitleImage(model.getImage());
