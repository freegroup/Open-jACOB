...
public final class PrintGroupAction extends PrintIFigureAction
{
  IFigure group=null;
  
  public IFigure getFigureToPrint()
  {
    return group;
  }
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
      group =((GroupEditPart)((IStructuredSelection)selection).getFirstElement()).getFigure();
    else
      group=null;
	}
}
