...
//  private final String[] tags;
  private final String[] keyWords={"{MANDATORID}","{USERID}","{LOGINID}","{USERPROPERTY."};
  private final TableAliasModel model;
  
  public ContentAssistProcessors(TableAliasModel model)
  {
    this.model = model;
