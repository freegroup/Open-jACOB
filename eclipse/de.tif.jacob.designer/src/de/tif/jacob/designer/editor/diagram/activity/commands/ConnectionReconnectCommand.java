 ...
 * </ol>
 * @see de.tif.jacob.designer.editor.diagram.activity.editpart.DiagramElementEditPart#createEditPolicies() for an
...
private DiagramElementModel newSource;
/** The new target endpoint. */
private DiagramElementModel newTarget;
/** The original source endpoint. */
private final DiagramElementModel oldSource;
/** The original target endpoint. */
private final DiagramElementModel oldTarget;
 ...
 */
public ConnectionReconnectCommand(TransitionModel conn) {
	if (conn == null) {
 ...
 */
public void setNewSource(DiagramElementModel connectionSource) {
 ...
 */
public void setNewTarget(DiagramElementModel connectionTarget) {
