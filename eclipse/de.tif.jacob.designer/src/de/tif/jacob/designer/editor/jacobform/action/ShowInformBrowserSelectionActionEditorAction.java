...
public final class ShowInformBrowserSelectionActionEditorAction extends de.tif.jacob.designer.actions.ShowSelectionActionEditorAction
{
  ...
  public ISelectionActionProvider getSelectionActionProvider()
  {
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
      provider =(ISelectionActionProvider)((InformBrowserEditPart)((IStructuredSelection)selection).getFirstElement()).getModel();
    else
      provider=null;
	}
}
