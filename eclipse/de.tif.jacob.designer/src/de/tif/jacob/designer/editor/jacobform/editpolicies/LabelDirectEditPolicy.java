...
import de.tif.jacob.designer.editor.jacobform.commands.ChangeButtonLabelCommand;
...
public class LabelDirectEditPolicy extends DirectEditPolicy
{
	...
	{
    Command cmd=null;
    UILabelModel label = (UILabelModel) getHost().getModel();
    // Datenbank gebundenes Label darf nicht editiert werden
    if(label instanceof UIDBLabelModel)
    	return null;
    ...
    {
      ChangeLabelLabelCommand textcmd = new ChangeLabelLabelCommand();
      UILabelModel caption = (UILabelModel) getHost().getModel();
