...
public class DBComboboxEditPart extends DBLocalInputFieldEditPart implements IStyleProvider
{
  public DBComboboxEditPart()
  {
    super(DBComboBoxFigure.class);
  }

  public void consumeStyle(Map<String, Object> style)
  {
    UIDBEnumComboboxModel model = (UIDBEnumComboboxModel)getModel();
