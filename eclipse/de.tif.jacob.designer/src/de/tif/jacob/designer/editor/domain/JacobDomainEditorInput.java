 ...
 * Comments
 */
public class JacobDomainEditorInput implements IEditorInput, IPersistableElement, TreeSelectionObjectModelProvider
{
  private final UIDomainModel domainModel;
  
  public JacobDomainEditorInput(UIDomainModel domain)
  {
  ...
  {
    return "Domain [" + domainModel.getName()+"]";
  }
  ...
  {
    if (obj instanceof JacobDomainEditorInput)
    {
      JacobDomainEditorInput other = (JacobDomainEditorInput) obj;
      return domainModel.equals(other.domainModel);
    }
