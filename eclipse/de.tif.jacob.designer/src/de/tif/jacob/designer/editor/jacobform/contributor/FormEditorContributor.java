 ...
 *
 */
package de.tif.jacob.designer.editor.jacobform.contributor;
...
import de.tif.jacob.designer.editor.jacobform.action.TextAlignLeftAction;
import de.tif.jacob.designer.editor.jacobform.action.TextFontAction;
import de.tif.jacob.designer.editor.jacobform.action.ToggleGridRetargetAction;
import de.tif.jacob.designer.editor.jacobform.action.ToggleSnapToGeometryRetargetAction;


public class FormEditorContributor extends ActionBarContributor 
{
  ...
  public void contributeToToolBar(IToolBarManager toolBarManager) 
  {
    ...
    toolBarManager.add(new TextFontAction());
  }
}