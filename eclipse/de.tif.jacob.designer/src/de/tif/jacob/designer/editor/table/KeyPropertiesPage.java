 ...
 * Comments
 */
public class KeyPropertiesPage extends FormPage
{
  private final KeyMasterBlock block;

  public KeyPropertiesPage(FormEditor editor)
  {
    super(editor, "Keys", "Keys");
    block = new KeyMasterBlock(this);
  }
  
  protected void select(KeyModel key)
  {
    this.block.select(key);
  }
