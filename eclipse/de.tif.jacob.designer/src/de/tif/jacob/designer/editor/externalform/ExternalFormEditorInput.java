 ...
 * Comments
 */
public class ExternalFormEditorInput implements IEditorInput, IPersistableElement, TreeSelectionObjectModelProvider
{
  private final UIExternalFormModel model;
  
  public ExternalFormEditorInput(UIExternalFormModel model)
  {
    this.model = model;
  }
  ...
  {
    if (obj instanceof ExternalFormEditorInput)
    {
      ExternalFormEditorInput other = (ExternalFormEditorInput) obj;
