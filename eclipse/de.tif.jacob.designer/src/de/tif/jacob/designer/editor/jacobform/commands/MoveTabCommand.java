 ...
 * @author Phil Zoio
 */
public class MoveTabCommand extends Command
{
	final private UITabModel      tab;
	final private int             from;
	final private int             to;

	public MoveTabCommand(UITabModel tab, int from, int to)
	{
		super();
		this.tab  = tab;
		this.from = from;
	...
	public void execute()
	{
		UITabContainerModel container = tab.getUITabContainerModel();
		container.setTabPosition(tab,to);
	}

	public void undo()
	{
    UITabContainerModel container = tab.getUITabContainerModel();
		container.setTabPosition(tab,from);
	}
}