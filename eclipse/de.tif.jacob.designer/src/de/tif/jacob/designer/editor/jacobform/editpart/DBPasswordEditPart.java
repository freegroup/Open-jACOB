...
public class DBPasswordEditPart extends DBLocalInputFieldEditPart implements IStyleProvider
{
  public DBPasswordEditPart()
  {
  ...
  {
    UIDBPasswordModel model = (UIDBPasswordModel)getModel();
