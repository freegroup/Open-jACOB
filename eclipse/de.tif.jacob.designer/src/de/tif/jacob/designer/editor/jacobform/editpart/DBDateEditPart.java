...
public class DBDateEditPart extends DBLocalInputFieldEditPart implements IStyleProvider
{
  public DBDateEditPart()
  {
    super(DBDateFigure.class);
  }

  public void consumeStyle(Map<String, Object> style)
  {
    UIDBDateModel model = (UIDBDateModel)getModel();
