 ...
 *  
 */
public class WarningInputDialog extends Dialog
{
  /**
   ...
   */
  public WarningInputDialog(Shell parentShell, String dialogTitle, String dialogMessage, String initialValue, IInputValidator validator)
  {
    super(parentShell);
