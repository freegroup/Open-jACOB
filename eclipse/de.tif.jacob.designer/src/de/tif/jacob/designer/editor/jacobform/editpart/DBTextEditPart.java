...
import de.tif.jacob.designer.editor.jacobform.figures.DBTextFigure;
...
public class DBTextEditPart extends DBLocalInputFieldEditPart implements IStyleProvider
{
  public DBTextEditPart()
  {
    super(DBTextFigure.class);
  }
	...
	public void setHighlight(RelationsetModel relationset)
	{
	  ...
	  else if(relationset.contains(((UIDBTextModel)getModel()).getGroupModel().getTableAliasModel()))
  ...
  {
    UIDBTextModel model = (UIDBTextModel)getModel();
