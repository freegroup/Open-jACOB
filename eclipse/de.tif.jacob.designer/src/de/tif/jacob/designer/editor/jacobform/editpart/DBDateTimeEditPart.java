...
public class DBDateTimeEditPart extends DBLocalInputFieldEditPart implements IStyleProvider
{
  public DBDateTimeEditPart()
  {
    super(DBDateTimeFigure.class);
  }

  public void consumeStyle(Map<String, Object> style)
  {
    UIDBDateTimeModel model = (UIDBDateTimeModel)getModel();
