...
import de.tif.jacob.designer.model.UIIBrowserProviderModel;

/**
 *
 */
public final class ShowBrowserEditorAction extends de.tif.jacob.designer.actions.ShowBrowserEditorAction
{
  BrowserModel model;
  ...
  public BrowserModel getBrowserModel()
  {
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
    {
      ...
      if(editPart.getModel() instanceof UIIBrowserProviderModel)
        model = ((UIIBrowserProviderModel)editPart.getModel()).getBrowserModel();
