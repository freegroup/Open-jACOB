 ...
 */
public class TextFigure extends DecoratedLabelFigure
{
  public TextFigure()
  {
    setBackgroundColor(Constants.COLOR_INPUTBACKGROUND);
    setLabelAlignment(PositionConstants.LEFT);
    setBorder(new SchemeBorder(SchemeBorder.SCHEMES.LOWERED)/*Constants.BORDER*/);
    setOpaque(true);
    setFont(FontFactory.getFont("Arial", ObjectModel.FONTSTYLE_NORMAL, ObjectModel.FONTWEIGHT_NORMAL,8));
  }
}