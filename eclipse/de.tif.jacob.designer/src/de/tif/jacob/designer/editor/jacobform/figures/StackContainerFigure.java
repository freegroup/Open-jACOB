 ...
 */
public class StackContainerFigure extends Figure implements ObjectFigure
{
  public StackContainerFigure()
  {
    setFont(Constants.FONT_NORMAL);
    
    setLayoutManager(new StackLayout());
    setBorder(new LineBorder(Constants.COLOR_BORDER_DARK));
  }
  ...
  public void setEmpty(boolean empty)
  {
    if(empty)
    {
      setBackgroundColor(Constants.COLOR_PANE_DARK);
      setOpaque(true);
