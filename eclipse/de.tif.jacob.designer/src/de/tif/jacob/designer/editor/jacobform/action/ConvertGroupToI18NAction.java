...
public class ConvertGroupToI18NAction extends de.tif.jacob.designer.actions.ConvertToI18NAction
{
  UIGroupModel captionModel;
  ...
  public void selectionChanged(IAction action, ISelection selection)
  {
    if (((IStructuredSelection) selection).getFirstElement() != null)
      captionModel = ((GroupEditPart) ((IStructuredSelection) selection).getFirstElement()).getGroupModel();
    else
      captionModel = null;
  }
