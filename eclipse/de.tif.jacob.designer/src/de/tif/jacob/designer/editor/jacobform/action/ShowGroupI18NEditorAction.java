...
public class ShowGroupI18NEditorAction extends de.tif.jacob.designer.actions.ShowI18NEditorAction 
{
  UIGroupModel model;
  ...
  public String getKey()
  {
    ...
    return model.getLabel().substring(1);
  }
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
      model =((GroupEditPart)((IStructuredSelection)selection).getFirstElement()).getGroupModel();
    else
      model=null;
	}
}
