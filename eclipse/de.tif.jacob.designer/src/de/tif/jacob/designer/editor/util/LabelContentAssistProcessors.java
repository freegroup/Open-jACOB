...
public class LabelContentAssistProcessors implements ISubjectControlContentAssistProcessor
{
  //  Proposal part before cursor
  private final JacobModel jacob;
  public LabelContentAssistProcessors(JacobModel jacob)
  {
    this.jacob=jacob;
  }
  ...
  private void computeStructureProposals(String qualifier, int documentOffset, List propList)
  {
    ...
    String keyWords[]=(String[])jacob.getI18NKeys().toArray(new String[0]);
