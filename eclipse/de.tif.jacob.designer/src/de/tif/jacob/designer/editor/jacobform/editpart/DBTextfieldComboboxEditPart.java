...
public class DBTextfieldComboboxEditPart extends DBLocalInputFieldEditPart implements IStyleProvider
{
  public DBTextfieldComboboxEditPart()
  {
    super(DBTextfieldComboBoxFigure.class);
  }

  public void consumeStyle(Map<String, Object> style)
  {
    UIDBTextfieldComboboxModel model = (UIDBTextfieldComboboxModel)getModel();
