 ...
 * @author Phil Zoio
 */
public class ChangeTransitionDescriptionCommand extends Command
{
	private final TransitionModel model;
	private String label;
	private String oldLabel;

	public ChangeTransitionDescriptionCommand(TransitionModel model)
	{
	  this.model = model;
	}
