...
public class ExtendedDirectEditManager extends DirectEditManager
{
	...
	public ExtendedDirectEditManager(GraphicalEditPart source, Class editorType, CellEditorLocator locator, Label label)
	{
	  ...
	  System.out.println("ExtendedDirectEditManager.ExtendedDirectEditManager");
		this.label = label;
	...
	{
	  System.out.println("ExtendedDirectEditManager.bringDown");
	...
	{
	  System.out.println("ExtendedDirectEditManager.initCellEditor");
	...
	{
	  System.out.println("ExtendedDirectEditManager.unhookListeners");
