 ...
 * Comments
 */
public class ExternalFormEditor extends FormEditor implements PropertyChangeListener,  ISelectionProvider
{
  List listeners = new ArrayList();
  ISelection theSelection = StructuredSelection.EMPTY;

  public static final String ID = "de.tif.jacob.designer.editor.externalform.ExternalFormEditor";

  private ExternalFormPropertiesPage page;
  private UIExternalFormModel model;
  
  /**
   *  
   */
  public ExternalFormEditor()
  {
  }
  ...
  protected void addPages()
  {
    try
    {
      addPage( page=new ExternalFormPropertiesPage(this));
    }
  ...
  public void init(IEditorSite site, IEditorInput input) throws PartInitException
  {
    ...
    model =((ExternalFormEditorInput) input).getFormModel();
    setPartName( model.getName());
    setTitleImage(model.getImage());
