...
public class DBListboxEditPart extends DBLocalInputFieldEditPart implements IStyleProvider
{

  public DBListboxEditPart()
  {
    super(DBListboxFigure.class);
  }
  

  public void consumeStyle(Map<String, Object> style)
  {
    UIDBListboxModel model = (UIDBListboxModel)getModel();
