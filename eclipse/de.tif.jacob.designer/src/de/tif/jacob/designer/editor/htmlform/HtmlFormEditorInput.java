 ...
 * Comments
 */
public class HtmlFormEditorInput implements IEditorInput, IPersistableElement, TreeSelectionObjectModelProvider
{
  private final UIHtmlFormModel model;
  
  public HtmlFormEditorInput(UIHtmlFormModel model)
  {
    this.model = model;
  }
  ...
  {
    if (obj instanceof HtmlFormEditorInput)
    {
      HtmlFormEditorInput other = (HtmlFormEditorInput) obj;
