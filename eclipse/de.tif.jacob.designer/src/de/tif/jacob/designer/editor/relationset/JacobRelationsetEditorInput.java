 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class JacobRelationsetEditorInput implements IEditorInput, IPersistableElement, TreeSelectionObjectModelProvider
{
  final RelationsetModel model;

  public JacobRelationsetEditorInput(RelationsetModel model)
  {
    this.model = model;
  }
  ...
  {
    if (obj instanceof JacobRelationsetEditorInput)
    {
      JacobRelationsetEditorInput other = (JacobRelationsetEditorInput) obj;
