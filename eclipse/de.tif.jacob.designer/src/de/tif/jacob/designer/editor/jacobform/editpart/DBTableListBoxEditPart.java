...
public class DBTableListBoxEditPart extends GroupDBElementEditPart implements GraphicalEditPart, IStyleProvider
{
  public DBTableListBoxEditPart()
  {
  ...
  public void openDBEditor()
  {
    ...
    // the table editor.
    //
    final UIDBTableListBoxModel model = (UIDBTableListBoxModel)getModel(); 
    new ShowTableEditorAction()
    {
      public TableModel getTableModel() {return model.getTableAliasModel().getTableModel(); }
    }.run(null);
  }
  ...
  public void refreshVisuals()
    ...
    UIDBTableListBoxModel model = (UIDBTableListBoxModel)getModel();
	...
	public void setHighlight(RelationsetModel relationset)
	{
	  ...
	  else if(relationset.contains(((UIDBTableListBoxModel)getModel()).getTableAliasModel()))
