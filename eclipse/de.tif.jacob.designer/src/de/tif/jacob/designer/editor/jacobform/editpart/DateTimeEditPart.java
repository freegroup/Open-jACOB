...
public class DateTimeEditPart extends GroupElementEditPart implements IStyleProvider
{
  public DateTimeEditPart()
  {
    super(DateTimeFigure.class);
  }

  public void consumeStyle(Map<String, Object> style)
  {
    UIDateTimeModel model = (UIDateTimeModel)getModel();
