...
public class DeleteButtonBarElementCommand extends Command
{
	private IButtonBarElementModel    button;
  ...
  public DeleteButtonBarElementCommand(UIButtonBarModel bar, IButtonBarElementModel button)
	{
		this.bar     = bar;
		this.button  = button;
	}
	public void execute()
	{
    eventClassName = button.getHookClassName();
