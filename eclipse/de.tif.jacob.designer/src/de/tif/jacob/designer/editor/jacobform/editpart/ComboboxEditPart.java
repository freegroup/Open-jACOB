...
public class ComboboxEditPart extends GroupElementEditPart implements IStyleProvider
{
  public ComboboxEditPart()
  {
    super(ComboBoxFigure.class);
  }

  public void consumeStyle(Map<String, Object> style)
  {
    UIComboboxModel model = (UIComboboxModel)getModel();
