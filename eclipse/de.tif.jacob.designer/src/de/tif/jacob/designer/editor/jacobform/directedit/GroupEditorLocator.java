 ...
 * @author Phil Zoio
 */
public class GroupEditorLocator implements CellEditorLocator
{
	 ...
	 *            the Label
	 */
	public GroupEditorLocator(GroupFigure groupFigure)
	{
	...
	{
	  System.out.println("GroupFigurEditorLocator.relocate");
		Text text = (Text) celleditor.getControl();

		Rectangle rect = groupFigure.getLabel().getBounds().getCopy();
		groupFigure.translateToAbsolute(rect);
