 ...
 *
 */
public class ShowTableAliasHookAction extends de.tif.jacob.designer.actions.ShowObjectModelHookAction
{
  ...
  public ObjectModel getObjectModel()
  {
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
      model =((TreeTableAliasObject)((IStructuredSelection)selection).getFirstElement()).getTableAliasModel();
    else 
      model=null;
	}
