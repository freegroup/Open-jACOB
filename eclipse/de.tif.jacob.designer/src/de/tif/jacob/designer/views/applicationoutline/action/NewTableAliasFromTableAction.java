 ...
 *
 */
public class NewTableAliasFromTableAction extends de.tif.jacob.designer.actions.NewTableAliasFromTableAction
{
  ...
  public TableModel getTableModel()
  {
	...
	public void selectionChanged(IAction action, ISelection selection) 
	{
	    if(((IStructuredSelection)selection).getFirstElement()!=null)
	      table =((TreeTableParent)((IStructuredSelection)selection).getFirstElement()).getTableModel();
	    else
	      table=null;
	}
}