 ...
 *
 */
public class DeleteExternalFormAction extends de.tif.jacob.designer.actions.DeleteExternalFormAction
{
  UIExternalFormModel form=null;
  ...
  public UIExternalFormModel getFormModel()
  {
	...
	public void selectionChanged(IAction action, ISelection selection) 
	{
	    if(((IStructuredSelection)selection).getFirstElement()!=null)
	      form =(UIExternalFormModel)((TreeFormObject)((IStructuredSelection)selection).getFirstElement()).getFormModel();
	    else
	      form=null;
	}
}