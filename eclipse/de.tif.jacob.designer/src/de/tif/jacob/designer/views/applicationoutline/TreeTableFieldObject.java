 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class TreeTableFieldObject extends TreeModelObject implements DblClickObject
{
	public TreeTableFieldObject(TreeViewer viewer, TreeParent parent, JacobModel jacob, TableModel table, FieldModel model) 
	{
  ...
  public String getName() 
	...
	/**
	 * direct edit in the tree editor
	 */
  public void setName(String name) throws Exception
  {
    getFieldModel().setName(name);
  }
	...
	public void dblClick()
  {
    ...
    {
      public FieldModel getFieldModel() {return (FieldModel)model; }
    }.run(null);
  }
