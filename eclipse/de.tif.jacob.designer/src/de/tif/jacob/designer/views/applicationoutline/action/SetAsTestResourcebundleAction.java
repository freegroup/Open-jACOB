...
import de.tif.jacob.designer.actions.SetTestRelationsetAction;
...
public final class SetAsTestResourcebundleAction extends de.tif.jacob.designer.actions.SetAsTestResourcebundleAction 
{
  JacobModel        model;
  I18NResourceModel resourcebundle;
  ...
  public I18NResourceModel getI18NResourceModel()
  {
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
    {
      ...
      resourcebundle = ((TreeI18NResourceObject)((IStructuredSelection)selection).getFirstElement()).getI18NResourceModel();
    }
	}
}
