 ...
 *
 */
public class DeleteRelationAction extends de.tif.jacob.designer.actions.DeleteRelationAction
{
  RelationModel model;
  ...
  public RelationModel getRelationModel()
  {
	...
	public void selectionChanged(IAction action, ISelection selection) 
	{
	    if(((IStructuredSelection)selection).getFirstElement()!=null)
	      model =((TreeRelationObject)((IStructuredSelection)selection).getFirstElement()).getRelationModel();
	    else
	      model=null;
	}
}
