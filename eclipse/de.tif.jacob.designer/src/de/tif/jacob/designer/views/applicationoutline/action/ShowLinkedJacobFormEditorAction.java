 ...
 *
 */
public final class ShowLinkedJacobFormEditorAction extends de.tif.jacob.designer.actions.ShowJacobFormEditorAction
{
  UIJacobFormModel model;
  ...
  public UIJacobFormModel getFormModel()
  {
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
      model =(UIJacobFormModel)((TreeLinkedFormObject)((IStructuredSelection)selection).getFirstElement()).getFormModel();
    else 
      model=null;
	}
