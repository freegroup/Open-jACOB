 ...
 *
 */
public final class ShowOwnDrawFormEditorAction extends de.tif.jacob.designer.actions.ShowOwnDrawFormEditorAction
{
  ...
  public UIMutableFormModel getFormModel()
  {
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
      model =(UIMutableFormModel)((TreeFormObject)((IStructuredSelection)selection).getFirstElement()).getFormModel();
    else 
      model=null;
	}
