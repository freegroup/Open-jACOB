...
public final class DeleteKeyAction extends de.tif.jacob.designer.actions.DeleteKeyAction 
{
  KeyModel model=null;
  ...
  public KeyModel getKeyModel()
  {
	...
	public void selectionChanged(IAction action, ISelection selection) 
	{
	    if(((IStructuredSelection)selection).getFirstElement()!=null)
	      model =((TreeKeyObject)((IStructuredSelection)selection).getFirstElement()).getKeyModel();
	    else
	      model=null;
	}
}
