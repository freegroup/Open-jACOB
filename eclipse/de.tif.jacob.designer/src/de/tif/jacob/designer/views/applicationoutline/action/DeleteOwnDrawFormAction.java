 ...
 *
 */
public class DeleteOwnDrawFormAction extends de.tif.jacob.designer.actions.DeleteMutableFormAction
{
  UIMutableFormModel form=null;
  ...
  public UIMutableFormModel getFormModel()
  {
	...
	public void selectionChanged(IAction action, ISelection selection) 
	{
	    if(((IStructuredSelection)selection).getFirstElement()!=null)
	      form =(UIMutableFormModel)((TreeFormObject)((IStructuredSelection)selection).getFirstElement()).getFormModel();
	    else
	      form=null;
	}
}