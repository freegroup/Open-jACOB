...
import de.tif.jacob.designer.views.search.ReferenceSearchQueryAlias;
import de.tif.jacob.designer.views.search.ReferenceSearchQueryBrowser;
import de.tif.jacob.designer.views.search.ReferenceSearchQueryFirstLevel;

/**
 *
 */
public final class ShowReferencesRelatedAliasAction extends de.tif.jacob.designer.actions.ShowReferencesAction
{
  ObjectModel model;
  ...
  {
    return new ReferenceSearchQueryAlias(model);
  }
