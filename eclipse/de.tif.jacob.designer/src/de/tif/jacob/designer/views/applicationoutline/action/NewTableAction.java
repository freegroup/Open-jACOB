 ...
 *
 */
public class NewTableAction extends de.tif.jacob.designer.actions.NewTableAction
{
	/**
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
      datasource =((TreePhysicalDataModelObject)((IStructuredSelection)selection).getFirstElement()).getDatasourceModel();
    else 
      datasource=null;
	}
}
