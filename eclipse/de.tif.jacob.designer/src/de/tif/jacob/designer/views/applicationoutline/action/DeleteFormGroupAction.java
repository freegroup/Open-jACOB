...
public final class DeleteFormGroupAction extends de.tif.jacob.designer.actions.DeleteFormGroupAction 
{
  UIFormGroupModel group=null;
  ...
  public UIFormGroupModel getFormGroupModel()
  {
	...
	public void selectionChanged(IAction action, ISelection selection) 
	{
	    if(((IStructuredSelection)selection).getFirstElement()!=null)
	      group = ((TreeFormGroupObject)((IStructuredSelection)selection).getFirstElement()).getFormGroupModel();
	    else
	      group = null;
	}
}
