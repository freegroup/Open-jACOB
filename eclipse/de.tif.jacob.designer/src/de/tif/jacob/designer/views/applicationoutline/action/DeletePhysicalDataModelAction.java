...
public final class DeletePhysicalDataModelAction extends de.tif.jacob.designer.actions.DeletePhysicalDataModelAction 
{
  PhysicalDataModel model=null;
  ...
  public PhysicalDataModel getPhysicalDataModel()
  {
	...
	public void selectionChanged(IAction action, ISelection selection) 
	{
	    if(((IStructuredSelection)selection).getFirstElement()!=null)
	      model =((TreePhysicalDataModelObject)((IStructuredSelection)selection).getFirstElement()).getDatasourceModel();
	    else
	      model=null;
	}
}
