 ...
 *
 */
public final class ShowJacobFormEditorAction extends de.tif.jacob.designer.actions.ShowJacobFormEditorAction
{
  ...
  public UIJacobFormModel getFormModel()
  {
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
      model =(UIJacobFormModel)((TreeFormObject)((IStructuredSelection)selection).getFirstElement()).getFormModel();
    else 
      model=null;
	}
