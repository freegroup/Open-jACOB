 ...
 *
 */
public final class ShowLinkedOwnDrawFormEditorAction extends de.tif.jacob.designer.actions.ShowLinkedOwnDrawFormEditorAction
{
  UIMutableFormModel model;
  ...
  public UIMutableFormModel getFormModel()
  {
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
      model =(UIMutableFormModel)((TreeLinkedFormObject)((IStructuredSelection)selection).getFirstElement()).getFormModel();
    else 
      model=null;
	}
