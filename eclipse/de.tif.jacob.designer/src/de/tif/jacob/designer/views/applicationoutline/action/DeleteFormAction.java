 ...
 *
 */
public class DeleteFormAction extends de.tif.jacob.designer.actions.DeleteFormAction
{
  UIJacobFormModel form=null;
  ...
  public UIJacobFormModel getFormModel()
  {
	...
	public void selectionChanged(IAction action, ISelection selection) 
	{
	    if(((IStructuredSelection)selection).getFirstElement()!=null)
	      form =(UIJacobFormModel)((TreeFormObject)((IStructuredSelection)selection).getFirstElement()).getFormModel();
	    else
	      form=null;
	}
}