 ...
 *
 */
public final class ShowExternalFormEditorAction extends de.tif.jacob.designer.actions.ShowExternalFormEditorAction
{
  UIExternalFormModel model;
  ...
  public UIExternalFormModel getFormModel()
  {
    ...
    if(((IStructuredSelection)selection).getFirstElement()!=null)
      model =(UIExternalFormModel)((TreeFormObject)((IStructuredSelection)selection).getFirstElement()).getFormModel();
    else 
      model=null;
	}
}
