 ...
 *
 */
public class NewBrowserFromAliasAction extends de.tif.jacob.designer.actions.NewBrowserFromAliasAction
{
  TableAliasModel alias=null;
  ...
  public TableAliasModel getTableAliasModel()
  {
	...
	public void selectionChanged(IAction action, ISelection selection) 
	{
	    if(((IStructuredSelection)selection).getFirstElement()!=null)
	      alias =((TreeTableAliasObject)((IStructuredSelection)selection).getFirstElement()).getTableAliasModel();
	    else
	      alias=null;
	}
}