...
public final class DeleteFieldAction extends de.tif.jacob.designer.actions.DeleteFieldAction 
{
  ...
  public FieldModel getFieldModel()
  {
	...
	public void selectionChanged(IAction action, ISelection selection) 
	{
	    if(((IStructuredSelection)selection).getFirstElement()!=null)
	      model =((TreeTableFieldObject)((IStructuredSelection)selection).getFirstElement()).getFieldModel();
	    else
	      model=null;
	}
}
