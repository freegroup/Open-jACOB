 ...
 * 
 */
public abstract class RemoveLinkedFormAction implements IObjectActionDelegate 
{
   ...
   * @return 
   */
  public abstract UIFormModel   getFormModel();
  ...
  {
    if (getFormModel() != null && getFormContainerModel()!=null)
    {
      getFormContainerModel().removeElement(getFormModel());
    }
  }
}
