...
import de.tif.jacob.designer.model.ScheduledJobSystemModel;
import de.tif.jacob.designer.util.ClassFinder;

/**
 * 
 */
public abstract  class NewScheduledJobSystemAction implements IObjectActionDelegate 
{
	...
	public final void run(IAction action)
  {
    ...
    {
      NewScheduledTaskWizard wizard = new NewScheduledTaskWizard(getJacobModel(),NewScheduledTaskWizard.TYPE_SYSTEM);
      ...
      dialog.create();
			...
			if(dialog.open()==Window.OK)
			{
			  ...
			  ScheduledJobSystemModel job = new ScheduledJobSystemModel(getJacobModel(),shortName, template+".java");
