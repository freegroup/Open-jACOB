 ...
 * 
 */
public abstract  class NewRelationsetAction implements IObjectActionDelegate 
{
	...
	public final void run(IAction action)
  {
    if (getJacobModel() != null)
    {
      ...
      InputDialog dialog = new InputDialog(shell, "Create Relation set", "Enter the name for the relation set",
					"newRelationset",
          new IInputValidator()
          {
            public String isValid(String newText)
            {
              ...
              if(getJacobModel().getRelationsetModel(newText)!=null)
      ...
      {
        final RelationsetModel relationset = new RelationsetModel(getJacobModel(),dialog.getValue());
        getJacobModel().addElement(relationset);
