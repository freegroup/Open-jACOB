 ...
 * 
 */
public abstract  class NewLinkedMutableFormAction implements IObjectActionDelegate 
{
	...
	public final void run(IAction action)
  {
    if (getJacobModel() != null)
    {
      ...
      NewMutableFormDialog nameDialog = new NewMutableFormDialog(shell,getJacobModel());
      nameDialog.create();
      if(nameDialog.open()==Window.OK)
      {
	      // create the new form and link them to the domain
	      //
        UIMutableFormModel form = new UIMutableFormModel(getJacobModel(),nameDialog.getFormName());
        ...
        // open the new form in the editor
          ...
          MutableFormEditorInput editorInput = new MutableFormEditorInput(form);
	        page.openEditor(editorInput, MutableFormEditor.ID, true);
	      }
