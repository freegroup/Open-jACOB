 ...
 * 
 */
public abstract  class NewLinkedExternalFormAction implements IObjectActionDelegate 
{
	...
	public final void run(IAction action)
  {
    if (getJacobModel() != null)
    {
      ...
      if(nameDialog.open()==Window.OK)
      {
	      ...
	      //
        UIExternalFormModel form = new UIExternalFormModel(getJacobModel(),nameDialog.getValue());
        ...
        getFormContainerModel().addElement(form);
          ...
          ExternalFormEditorInput editorInput = new ExternalFormEditorInput(form);
	        page.openEditor(editorInput, ExternalFormEditor.ID, true);
	      }
