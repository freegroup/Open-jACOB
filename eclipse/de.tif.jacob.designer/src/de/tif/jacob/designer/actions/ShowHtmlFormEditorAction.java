 ...
 * 
 */
public abstract class ShowHtmlFormEditorAction implements IObjectActionDelegate 
{
   ...
   * @return 
   */
  public abstract UIHtmlFormModel getFormModel();
	...
	public final void run(IAction action)
  {
      ...
      try
      {
        ...
        HtmlFormEditorInput editorInput = new HtmlFormEditorInput(getFormModel());
