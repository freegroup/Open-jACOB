 ...
 * 
 */
public abstract  class NewEntryPointCMDAction implements IObjectActionDelegate 
{
	...
	public final void run(IAction action)
  {
    if (getJacobModel() != null)
    {
      ...
      InputDialog dialog = new InputDialog(shell, "Create CMD Entry Point", "Enter the name of the new cmd entry point",
				          "NewCmdEntryPoint",
				          new IInputValidator()
				          {
				            public String isValid(String newJob )
				            {
				              ...
				              if(getJacobModel().getEntryPointCMDModel(newJob)!=null)
				...
				{
				  EntryPointCMDModel entry = new EntryPointCMDModel(getJacobModel(),dialog.getValue());
