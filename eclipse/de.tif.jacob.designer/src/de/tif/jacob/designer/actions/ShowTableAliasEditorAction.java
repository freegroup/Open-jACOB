 ...
 * 
 */
public abstract class ShowTableAliasEditorAction implements IObjectActionDelegate 
{
	...
	public final void run(IAction action)
  {
    try
    {
      ...
      JacobAliasEditorInput editorInput = new JacobAliasEditorInput( getTableAliasModel());
