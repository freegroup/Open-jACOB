 ...
 * 
 */
public abstract class ShowTableKeyEditorAction implements IObjectActionDelegate 
{
	...
	public final void run(IAction action)
  {
    try
    {
      ...
      JacobTableEditorInput editorInput = new JacobTableEditorInput(key.getTableModel());
      
      JacobTableEditor editor = (JacobTableEditor) page.openEditor(editorInput, JacobTableEditor.ID, true);
      editor.navigateToKey(key);
    }
