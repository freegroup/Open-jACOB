...
public class NewMutableFormDialog extends TitleAreaDialog
{
  Label      errorMessage;
  Text       name;
  List       tablealiases;
  ...
  public static void main(String[] args) 
  {
		...
		new NewMutableFormDialog(shell,null).open();
	}
   ...
   * @param parent
   */
  public NewMutableFormDialog(Shell parent, JacobModel jacob)
  {
    super(parent);
  ...
  {      
    setTitle("Create a mutable Form");
    setMessage("Enter the name of the new form and select the anchor DB Table Alias");
    setTitleImage(JacobDesigner.getImage("new_mutable_form_dialog.png"));
