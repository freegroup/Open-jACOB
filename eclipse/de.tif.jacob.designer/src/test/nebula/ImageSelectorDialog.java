...
public class ImageSelectorDialog extends Dialog 
{
   ...
   */
  public ImageSelectorDialog(Shell parent) {
    super(parent, SWT.SHELL_TRIM | SWT.APPLICATION_MODAL);
    boldFont = new Font(parent.getDisplay(), "Helvetica", 9, SWT.BOLD);
  }
  ...
  private void createContents(final Shell shell) 
  {
    ...
    String s2="<PROJECT>/java/jacob/resources";
    String s3=" directory";
...
//    FormDebugUtils.debugLayout(builder.getComposite());
    ...
    List files = Directory.getAll(new File("/home/andherz/workspace/openjacob.engine/webapp/icons"),false);
