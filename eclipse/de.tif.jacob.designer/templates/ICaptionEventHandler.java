 ...
 * @author {author}
 */
public class {class} extends ICaptionEventHandler  // implements IOnClickEventHandler
{
  /**
   * The internal revision control system id.
   */
  static public final transient String RCS_ID = "$Id: ICaptionEventHandler.java,v 1.2 2009/06/05 10:33:41 ibissw Exp $";
