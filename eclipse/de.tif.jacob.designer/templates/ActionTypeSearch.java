...
/**
 * The event handler for the {class} search button.<br>
 * 
 * @author {author}
 */
public class {class} extends ISearchActionEventHandler 
{
	static public final transient String RCS_ID = "$Id: ActionTypeSearch.java,v 1.1 2007/05/18 16:13:26 freegroup Exp $";
