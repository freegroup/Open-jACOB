...
/**
 * The event handler for the {class} new button.<br>
 * 
 * @author {author}
 */
public class {class} extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ActionTypeNewRecord.java,v 1.1 2007/05/18 16:13:26 freegroup Exp $";
