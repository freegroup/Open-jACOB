...
/**
 * The event handler for the {class} update button.<br>
 * 
 * @author {author}
 */
public class {class} extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ActionTypeSearchUpdateRecord.java,v 1.1 2007/05/18 16:13:26 freegroup Exp $";
