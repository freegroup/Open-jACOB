...
public final class Request_enabler
{
   private Request_enabler(){}

   // the name of the table alias	 
   public final static String NAME = "request_enabler";
	 
   // All field names of the table alias "request_enabler"
   /** 
     required: true<br>
     type:     LONG<br>
   */
