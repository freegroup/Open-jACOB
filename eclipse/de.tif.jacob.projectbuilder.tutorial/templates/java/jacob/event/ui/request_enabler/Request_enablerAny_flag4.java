 ...
 *
 */
public class Request_enablerAny_flag4 extends ICheckBoxEventHandler
{
  static public  final transient String RCS_ID = "$Id: Request_enablerAny_flag4.java,v 1.1 2007/11/25 22:19:38 freegroup Exp $";
  ...
  static private final transient Log logger = AppLogger.getLogger();
	...
	public void onGroupStatusChanged(IClientContext context, GroupState state,	IGuiElement emitter) throws Exception 
	{
		if(state== GuiElement.UPDATE || state== GuiElement.NEW)
			emitter.setEnable(context.getSelectedRecord().getSaveStringValue("state").equals("rejected"));
	}
