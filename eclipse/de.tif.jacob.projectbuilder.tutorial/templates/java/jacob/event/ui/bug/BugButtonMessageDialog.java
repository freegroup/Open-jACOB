 ...
 * 
 * Created on Sun Feb 27 12:48:34 CET 2005
 *
 */
...
import de.tif.jacob.screen.event.IButtonEventHandler;
 ...
 /**
  * The Event handler for the BugButtonMessageDialog-Button.<br>
  ...
  *
  */
public class BugButtonMessageDialog extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: BugButtonMessageDialog.java,v 1.1 2007/11/25 22:19:37 freegroup Exp $";
  ...
  {
 		IMessageDialog dialog = context.createMessageDialog("I'm a simple message dialog.");
 		dialog.show();
  }
