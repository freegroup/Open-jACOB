 ...
 * 
 * Created on Mon Mar 21 09:35:37 CET 2005
 *
 */
 ...
 *
 */
public class PersonButtonLevenshteinSearch extends ISearchActionEventHandler 
{
  static public final transient String RCS_ID = "$Id: PersonButtonLevenshteinSearch.java,v 1.1 2007/11/25 22:19:39 freegroup Exp $";
   ...
   */
	...
	{
	  button.setLabel("Levenshtein Search");
	}
	...
	public void modifyQbe(IClientContext context, IActionEmitter emitter)throws Exception 
	{
		...
		List result = PersonSearchFactory.search(PersonSearchFactory.LEVENSHTEIN, value,value.length()/2);
