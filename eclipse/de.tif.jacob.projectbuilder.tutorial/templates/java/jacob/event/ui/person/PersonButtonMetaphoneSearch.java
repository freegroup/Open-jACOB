 ...
 * 
 * Created on Tue Mar 22 10:28:26 CET 2005
 *
 */
 ...
 *
 */
public class PersonButtonMetaphoneSearch extends ISearchActionEventHandler 
{
  static public final transient String RCS_ID = "$Id: PersonButtonMetaphoneSearch.java,v 1.1 2007/11/25 22:19:39 freegroup Exp $";
   ...
   */
	...
	{
	  button.setLabel("Metaphone Search");
	}
	...
	public void modifyQbe(IClientContext context, IActionEmitter emitter)throws Exception 
	{
		...
		List result = PersonSearchFactory.search(PersonSearchFactory.METAPHONE, value,100);
