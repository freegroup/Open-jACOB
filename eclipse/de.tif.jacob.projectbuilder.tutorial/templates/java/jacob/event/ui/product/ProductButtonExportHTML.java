 ...
 * 
 * Created on Mon Feb 28 09:31:26 CET 2005
 *
 */
...
import de.tif.jacob.transformer.Transformer;
 ...
 /**
  * The Event handler for the ProductButtonExportHTML-Button.<br>
  ...
  *
  */
public class ProductButtonExportHTML extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProductButtonExportHTML.java,v 1.1 2007/11/25 22:19:39 freegroup Exp $";
 	...
 	public void onAction(IClientContext context, IGuiElement button) throws Exception
  {
    ...
    //
    URL xsl = jacob.resources.ResourceProvider.class.getResource("./stylesheet/product2html.xsl");
    
    // Render the XML data with the xsl stylesheet to an HTML document.
    // Valid mime types for the transformer are:
		...
		//	-  text/html
    //
   	byte[] document=Transformer.render(sb.toString(),xsl,"text/html");
   	
   	// Send the result of the transformation to the user
   	//
    IDocumentDialog dialog = context.createDocumentDialog("text/html","product.html",document);
    dialog.show(550,400);
  }
