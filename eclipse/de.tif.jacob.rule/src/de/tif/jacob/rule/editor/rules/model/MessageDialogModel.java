...
public class MessageDialogModel extends AbstractBusinessObjectModel implements AbstractTargetModel
{
  public MessageDialogModel()
  {
    ...
    method.setBusinessClass(UserInformation.class.getName());
   ...
   * @param castorRule
   */
  public MessageDialogModel(RulesetModel parent, Rule castorRule)
  {
