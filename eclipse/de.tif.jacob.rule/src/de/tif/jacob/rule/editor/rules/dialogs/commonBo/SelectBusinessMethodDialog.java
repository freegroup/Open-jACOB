...
public class SelectBusinessMethodDialog extends Dialog
{
  protected BusinessObjectModel model;
  ...
  public static void main(String[] args) 
  {
		...
		new SelectBusinessMethodDialog(shell,null).open();
	}
   ...
   * @param parent
   */
  public SelectBusinessMethodDialog(Shell parent, BusinessObjectModel model)
  {
...
//		FormDebugUtils.debugLayout(builder.getComposite());
  ...
  private Control createOkButton(Shell parent)
  {
  	...
  	okButton.addSelectionListener(new SelectionAdapter() 
        ...
        if(treeViewer.getSelection() instanceof IStructuredSelection)
        {
        	...
        	if(ss.getFirstElement() instanceof BusinessObjectMethodTreeNode)
        	{
        		updateModel((BusinessObjectMethodTreeNode)ss.getFirstElement());
        		shell.dispose();
        	}
        }
			}
  ...
  private Control createTree(Shell parent)
  {
    ...
    treeViewer.addSelectionChangedListener(new ISelectionChangedListener() 
        ...
        if(treeViewer.getSelection() instanceof IStructuredSelection)
        {
        	...
        	if(ss.getFirstElement() instanceof BusinessObjectMethodTreeNode)
        	{
        		updateView((BusinessObjectMethodTreeNode)ss.getFirstElement());
        	}
        	else
        	{
        		updateView(null);
    ...
    SelectBOMethodContentProvider contentProvider = new SelectBOMethodContentProvider(treeViewer, model);
  ...
  protected void updateModel(BusinessObjectMethodTreeNode node)
  {
  	...
  	model.setBusinessObjectClass(node.getBusinessObjectClassName());
  	model.setBusinessObjectMethod(node.getBusinessObjectMethod());
  }
  
  protected void updateView(BusinessObjectMethodTreeNode node)
  {
  	if(node==null)
  	{
  		description.setText("");
