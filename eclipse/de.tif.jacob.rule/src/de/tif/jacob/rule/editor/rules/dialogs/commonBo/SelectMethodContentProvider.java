...
public class SelectMethodContentProvider implements IStructuredContentProvider, ITreeContentProvider
{
  ...
  protected SelectMethodContentProvider(TreeViewer viewer, BusinessObjectModel initialModel)
  {
      this.viewer = viewer;
  ...
  private void initialize()
  {
    ...
    try 
    {
      ...
      String className = "de.tif.jacob.ruleengine.BusinessObject";
