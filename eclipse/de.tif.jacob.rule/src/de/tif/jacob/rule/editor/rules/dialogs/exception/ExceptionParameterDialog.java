 ...
 *
 */
package de.tif.jacob.rule.editor.rules.dialogs.exception;
...
public class ExceptionParameterDialog extends TitleAreaDialog
{
  protected ExceptionModel model;
  ...
  public static void main(String[] args) 
  {
		...
		new ExceptionParameterDialog(shell,null).open();
	}
   ...
   * @param parent
   */
  public ExceptionParameterDialog(Shell parent, ExceptionModel model)
  {
    super(parent);
  ...
  {      
    setTitle("Abort the rule");
    setMessage("Abort the rule flow.");
    setTitleImage(JacobDesigner.getImage("dialogheader_exception.gif"));
