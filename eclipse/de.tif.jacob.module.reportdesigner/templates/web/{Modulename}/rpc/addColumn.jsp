...
try
{
    ...
    if(jacobSession!=null)
    {
        ...
        CastorLayoutColumn castorColumn = new CastorLayoutColumn();     
        castorColumn.setTableAlias(table);
        castorColumn.setField(field);
        castorColumn.setLabel(field);

        part.getColumns().addColumn(castorColumn);
        out.println(f);
      }
}
catch(Exception exc)
