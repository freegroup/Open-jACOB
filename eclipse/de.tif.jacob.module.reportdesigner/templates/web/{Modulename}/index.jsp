...
<img border="0" src="{Modulename}_layout.png" style="position: absolute; top: 5px; left: 15px; width: 77px; height: 68px;"/>
...
<div id="content_area">
    <div class="section" id="first_page_header">
      ...
      <div id="first_page_header_collapse_area">
          <textarea id="first_page_header_textarea"  class="autogrow autosuggest" rows="1" wrap="OFF"><%=layout.getPrologue().getText()%></textarea>
      </div>
