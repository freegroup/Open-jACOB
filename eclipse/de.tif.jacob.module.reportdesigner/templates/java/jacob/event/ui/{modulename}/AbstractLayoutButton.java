...
{
  static public final transient String RCS_ID = "$Id: AbstractLayoutButton.java,v 1.1 2009/12/14 23:18:52 freegroup Exp $";
  ...
  public void onGroupStatusChanged(IClientContext context, GroupState state, IGuiElement element) throws Exception
  {
    ...
    if(report!=null)
    {
      ...
      // Ein Report welcher nicht dem eingeloggten Anwender gehört ist nicht editierbar
