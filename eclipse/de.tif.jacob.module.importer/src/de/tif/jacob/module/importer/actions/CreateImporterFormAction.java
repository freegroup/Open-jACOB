package de.tif.jacob.module.importer.actions;
...
import de.tif.jacob.module.importer.Activator;
import de.tif.jacob.module.popup.actions.AbstractModuleAction;

public class CreateImporterFormAction extends AbstractModuleAction
{
  ...
  /**
	 ...
	 */
	public CreateImporterFormAction() 
  {
		super();
	}
