 ...
 */
package jacob.event.ui.{modulename}_definition;
 ...
 * @author andherz
 */
 public class Draw2DEditorGroup extends IHtmlGroupEventHandler 
 {
	static public final transient String RCS_ID = "$Id: Draw2DEditorGroup.java,v 1.2 2009/07/15 06:57:01 freegroup Exp $";
	...
	{
		return new String[]{"{modulename}/dbTube.js"};  
	}
	   ...
	   if(link.equals("search"))
		...
		else if(link.equals("new"))
		{
		   ...
		   try
		   {
            ...
            IDataTableRecord newRecord = {Modulename}_definition.newRecord(context);
            newRecord.setStringValue(newRecord.getCurrentTransaction(), {Modulename}_definition.xml, content);
            newRecord.setStringValue(newRecord.getCurrentTransaction(), {Modulename}_definition.name, "Import Name");
