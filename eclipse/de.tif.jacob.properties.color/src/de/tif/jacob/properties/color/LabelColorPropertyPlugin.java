...
public class LabelColorPropertyPlugin extends IPropertyPlugin
{
  public LabelColorPropertyPlugin()
  {
  }
  ...
  public Object getPropertyValue(ObjectModel model, Object propName)
  {
    if (propName == ObjectModel.ID_PROPERTY_COLOR)
      return ((UILabelModel)model).getColor().getRGB();
  ...
  public boolean setPropertyValue(ObjectModel model, Object propName, Object val)
  {
    if(propName == ObjectModel.ID_PROPERTY_COLOR)
    {
      ((UILabelModel)model).setColor(new Color(null,(RGB)val));
      return true;
    }
