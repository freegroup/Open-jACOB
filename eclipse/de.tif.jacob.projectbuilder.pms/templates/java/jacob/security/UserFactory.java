...
{
  static public final transient String RCS_ID = "$Id: UserFactory.java,v 1.1 2007/11/25 22:17:54 freegroup Exp $";
  ...
  public IUser getValid(String loginId, String passwd) throws AuthenticationException, GeneralSecurityException
  {
    ...
    catch (UserNotExistingException ex)
    {
      ...
      IUser anonymous = createInitialUser(ANON_USER_ID,"Anonymous User");
