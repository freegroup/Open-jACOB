...
public final class Parent_process
{
   private Parent_process(){}

   // the name of the table alias	 
   public final static String NAME = "parent_process";
	 
   // All field names of the table alias "parent_process"
   /** 
     required: true<br>
     type:     LONG<br>
   */
