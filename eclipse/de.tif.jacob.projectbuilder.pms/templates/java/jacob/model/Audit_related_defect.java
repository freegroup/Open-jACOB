...
public final class Audit_related_defect
{
   private Audit_related_defect(){}

   // the name of the table alias	 
   public final static String NAME = "audit_related_defect";
	 
   // All field names of the table alias "audit_related_defect"
   /** 
     required: true<br>
     type:     LONG<br>
   */
