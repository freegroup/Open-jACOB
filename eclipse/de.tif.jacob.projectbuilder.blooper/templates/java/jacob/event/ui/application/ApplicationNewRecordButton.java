 ...
 * 
 * Created on Sun Dec 17 19:06:22 CET 2006
 */
...
/**
 * The event handler for the ApplicationNewRecordButton new button.<br>
 * 
 * @author andherz
 */
public class ApplicationNewRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ApplicationNewRecordButton.java,v 1.1 2007/11/25 22:10:32 freegroup Exp $";
	...
	public boolean beforeAction(IClientContext context, IActionEmitter button) throws Exception 
	{
		...
		{
			alert("No rights to create a new account.");
			return false;
		}
		return true;
	}
