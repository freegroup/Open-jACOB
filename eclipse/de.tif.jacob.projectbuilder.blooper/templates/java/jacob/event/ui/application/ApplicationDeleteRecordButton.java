 ...
 * 
 * Created on Sun Dec 17 19:00:15 CET 2006
 */
 ...
 *
 */
public class ApplicationDeleteRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ApplicationDeleteRecordButton.java,v 1.1 2007/11/25 22:10:32 freegroup Exp $";
	...
	public boolean beforeAction(IClientContext context, IActionEmitter button) throws Exception 
	{
		...
		{
			alert("No rights to delete a record.");
			return false;
		}
		return true;
	}
