 ...
 * 
 * Created on Sun Dec 17 18:59:19 CET 2006
 */
package jacob.event.ui.application;
...
/**
 * The event handler for the ApplicationSearchUpdateRecordButton update button.<br>
 * 
 * @author andherz
 */
public class ApplicationSearchUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ApplicationSearchUpdateRecordButton.java,v 1.1 2007/11/25 22:10:32 freegroup Exp $";
	...
	public boolean beforeAction(IClientContext context, IActionEmitter button) throws Exception 
	{
		...
		{
			alert("No rights to change or create a record.");
			return false;
		}
