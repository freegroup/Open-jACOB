 ...
 * 
 * Created on Thu Dec 07 15:31:38 CET 2006
 */
...
/**
 * The event handler for the EmailSearchUpdateRecordButton update button.<br>
 * 
 * @author andherz
 */
public class EmailSearchUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: EmailSearchUpdateRecordButton.java,v 1.1 2007/11/25 22:10:31 freegroup Exp $";
