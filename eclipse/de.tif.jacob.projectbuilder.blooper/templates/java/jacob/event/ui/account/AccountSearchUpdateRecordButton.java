 ...
 * 
 * Created on Thu Dec 07 15:41:16 CET 2006
 */
...
/**
 * The event handler for the AccountSearchUpdateRecordButton update button.<br>
 * 
 * @author andherz
 */
public class AccountSearchUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: AccountSearchUpdateRecordButton.java,v 1.1 2007/11/25 22:10:33 freegroup Exp $";
	...
	public boolean beforeAction(IClientContext context, IActionEmitter button) throws Exception 
	{
		...
		if (context.getGroup().getDataStatus()== IGuiElement.SELECTED)
		{
			...
			{
				alert("No rights to change a record.");
				return false;
			}
		}
		else 
