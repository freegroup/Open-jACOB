 ...
 * 
 * Created on Mon Jul 12 16:44:57 CEST 2010
 */
...
/**
 * The event handler for the DatasourceIndexOptimize record selected button.<br>
 * The {@link onAction(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * Insert your custom code within this method.<br>
 * 
 * @author andreas
 */
public class DatasourceIndexOptimize extends IButtonEventHandler 
{
  static public final transient String RCS_ID = "$Id: DatasourceIndexOptimize.java,v 1.2 2010/07/27 10:41:53 ibissw Exp $";
  ...
  public void onAction(IClientContext context, IGuiElement button) throws Exception
  {
    ...
    if (dataSource instanceof IndexDataSource)
    {
      ...
      alert("Datasource successfully optimized");
    }
  }
