...
package jacob.event.ui.process_history;
...
/**
 * The event handler for the Process_historyDeleteAll generic button.<br>
 * The {@link onAction(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * Insert your custom code within this method.<br>
 * 
 * @author andreas
 */
public class Process_historyDeleteAll extends IButtonEventHandler
{
  static public final transient String RCS_ID = "$Id: Process_historyDeleteAll.java,v 1.1 2007/01/19 07:44:34 freegroup Exp $";
  ...
  private static class DeleteAllCallback implements IOkCancelDialogCallback
  {
    ...
    public void onOk(IClientContext context) throws Exception
    {
      ...
      try
      {
        // delete process info records first
        IDataTable processInfo = accessor.getTable("process_info");
        processInfo.qbeClear();
        processInfo.fastDelete(trans);

        // delete process history records then
