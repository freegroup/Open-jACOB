...
/**
 * The event handler for the Sql_historyDeleteAllRecord generic button.<br>
 * The {@link onAction(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * Insert your custom code within this method.<br>
 * 
 * @author andreas
 */
public class Sql_historyDeleteAllRecord extends IButtonEventHandler 
{
  static public final transient String RCS_ID = "$Id: Sql_historyDeleteAllRecord.java,v 1.1 2007/01/19 07:44:33 freegroup Exp $";
