...
public final class Activesession
{
   ...
   public final static String NAME = "activesession";
	 
   // All field names of the table alias "activesession"
   /** 
    * <br>
    * <br>
    ...
    **/
   public final static String  activesince = "activesince";
    ...
    * type:     <b>TEXT</b><br>
    **/
   public final static String  clienthostaddress = "clientHostAddress";
    ...
    * type:     <b>TEXT</b><br>
    **/
   public final static String  clientusername = "clientUserName";
    ...
    * type:     <b>TEXT</b><br>
    **/
   public final static String  clienthostname = "clientHostName";
