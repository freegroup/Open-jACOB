...
%>
<script>
DEFAULT_TABLE_BROWSER_HEIGHT=17;
(function() {
  function ellipsis(e) {
    var w = e.getWidth()-10;
    var t = e.innerHTML;
...
%>
<div id=navigationbar name=navigationbar class="listbar" style="position:absolute;width:180px;height:100%;top:0px;left:0px;">

<div class="listbar_header"><%=context.getUser().getFullName()%> 
<%
...
<%
        ...
        while(iter.hasNext())
        {
            ...
            {
                out.println("<div id=\""+domain.getEtrHashCode()+"\" class=\"simpleNavigationLevel1Selected\" >"+label+"</div>");
                for(int i=0; i<entries.length; i++)
                {
                  ...
                  if(onClickAction!=null)
                  {
                     ...
                     if(entry.getColor()!=null)
                        out.print(" style=\"color:"+entry.getColor()+";\" ");
                     if(domain.isCurrentNavigationEntry(entry) && domain == context.getDomain())
                        out.print(" class=simpleNavigationLevel2Selected " );
                     else
                        out.print(" class=simpleNavigationLevel2Normal " );
            ...
            {
                out.println("<div  id=\""+domain.getEtrHashCode()+"\" class=\"simpleNavigationLevel1Normal\" ");
