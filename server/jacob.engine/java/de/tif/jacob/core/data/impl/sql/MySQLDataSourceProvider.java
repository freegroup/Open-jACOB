...
public final class MySQLDataSourceProvider extends EnterpriseDataSourceProvider
{
  static public transient final String RCS_ID = "$Id: MySQLDataSourceProvider.java,v 1.1 2006-12-21 11:25:23 sonntag Exp $";
  static public transient final String RCS_REV = "$Revision: 1.1 $";
  
  public Class getDataSourceClassByName(String rdbName)
  {
    if ("MySQL".equals(rdbName))
