...
import de.tif.jacob.core.adjustment.impl.History;
 ...
 */
public final class QeSHistory extends History
{
	static public final transient String RCS_ID = "$Id: QeSHistory.java,v 1.3 2010-06-22 22:34:06 sonntag Exp $";
      ...
      if (table.getPrimaryKey().getTableFields().size() != 1 || !table.getPrimaryKey().getTableFields().get(0).equals(table.getRepresentativeField()))
      {
        ...
        if (linkedRecord == null)
        {
          ...
          if (trans != null)
          {
            ...
            linkedRecord = (DataTableRecord) ((DataTransaction) trans).getRecord(table, primaryKey);
          }
