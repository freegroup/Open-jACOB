...
public class FormsDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FormsDescriptor() {
        ...
        //-- _formList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(de.tif.qes.adf.castor.Form.class, "_formList", "Form", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Forms target = (Forms) object;
                    target.addForm( (de.tif.qes.adf.castor.Form) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new de.tif.qes.adf.castor.Form();
            }
        } );
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        desc.setValidator(fieldValidator);
    } //-- de.tif.qes.adf.castor.FormsDescriptor()
    ...
    {
        return de.tif.qes.adf.castor.Forms.class;
