...
/**
 * Class LongTextDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class LongTextDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LongTextDescriptor() {
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                LongText target = (LongText) object;
        ...
        //-- _longTextMode
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_longTextMode", "LongTextMode", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    LongText target = (LongText) object;
                    target.setLongTextMode( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _longTextMode
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            StringValidator typeValidator = new StringValidator();
        ...
        desc.setValidator(fieldValidator);
    } //-- de.tif.qes.adf.castor.LongTextDescriptor()
    ...
    {
        return de.tif.qes.adf.castor.LongText.class;
