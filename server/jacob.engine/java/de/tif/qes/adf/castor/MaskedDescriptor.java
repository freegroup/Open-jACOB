 ...
 */
public class MaskedDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MaskedDescriptor() {
        ...
        //-- _mask
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_mask", "Mask", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Masked target = (Masked) object;
                    target.setMask( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- de.tif.qes.adf.castor.MaskedDescriptor()
    ...
    {
        return de.tif.qes.adf.castor.Masked.class;
