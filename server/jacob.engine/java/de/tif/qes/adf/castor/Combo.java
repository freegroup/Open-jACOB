...
public class Combo implements java.io.Serializable {
     ...
     */
    private de.tif.qes.adf.castor.Items _items;
     ...
     * the following description: Anmerkung: Mußte optional
     * gemacht werden, da QDesigner beim Konvertieren von ADF5.0
     * Mist macht!
     * 
     * @return the value of field 'items'.
     */
    public de.tif.qes.adf.castor.Items getItems()
    {
        return this._items;
    } //-- de.tif.qes.adf.castor.Items getItems() 
     ...
     * following description: Anmerkung: Mußte optional gemacht
     * werden, da QDesigner beim Konvertieren von ADF5.0 Mist
     * macht!
     * 
     * @param items the value of field 'items'.
     */
    public void setItems(de.tif.qes.adf.castor.Items items)
    {
        this._items = items;
    } //-- void setItems(de.tif.qes.adf.castor.Items) 
    ...
    /**
     * Method unmarshalCombo
     * 
     * @param reader
     */
    public static java.lang.Object unmarshalCombo(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.tif.qes.adf.castor.Combo) Unmarshaller.unmarshal(de.tif.qes.adf.castor.Combo.class, reader);
    } //-- java.lang.Object unmarshalCombo(java.io.Reader) 
