...
%>
  ...
  document.body.addKeyDown(40,function(){onCursorDownKey('<%=foreignBrowser%>')});
  document.body.addKeyDown(38,function(){onCursorUpKey('<%=foreignBrowser%>')});
  document.body.addKeyDown(13,function(){onEnter('<%=foreignBrowser%>')});
