<%--
     This file is part of Open-Beryl
...
%>
<script>
var expandCurrentImage = "themes/Beryl/images/ns-expand_current.png";
var expandImage        = "themes/Beryl/images/ns-expand.png";
var collapseImage      = "themes/Beryl/images/ns-collapse.png";
    ...
    <%
          ...
          while (iter.hasNext())
          {
            ...
            if (domain.getCanCollapse() == false)
            {
              if (!hideDomainLabel)
              {
                out.println("<div><table width='80%'><tr><td width='100%' class=\"simpleNavigationLevel1Normal\"  style='cursor:default' >");
            ...
            else
            {
              ...
              if (!hideDomainLabel)
              {
                ...
                //
                out.println("<div><table width='80%'><tr onclick=\"toogleNavigation(" + domain.getId() + ",'" + domain.getEtrHashCode() + "'," + isCurrentDomain + ");\"><td width='100%' class=\"simpleNavigationLevel1Normal\" style='cursor:pointer;'>");
                out.println(StringUtil.htmlEncode(label));
                out.println("</td><td  align='right'>");
                if (Boolean.TRUE.equals(domain.isOpen()))
                {
                  out.println("<img style='cursor:pointer;' id='image_" + domain.getId() + "' src='themes/Beryl/images/ns-collapse.png'>");
                  out.println("</td></tr></table></div>");
                  out.println("<div id=\"" + domain.getEtrHashCode() + "\" >");
                }
                else
                {
                  if (domain == context.getDomain())
                    out.println("<img style='cursor:pointer;' id='image_" + domain.getId() + "' current='true' src='themes/Beryl/images/ns-expand_current.png'>");
                  else
                    out.println("<img style='cursor:pointer;' id='image_" + domain.getId() + "' src='themes/Beryl/images/ns-expand.png'>");
                  out.println("</td></tr></table></div>");
