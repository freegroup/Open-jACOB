...
<div id=navigationbar name=navigationbar class="listbar" style="position:absolute;width:230px;height:100%;top:0px;left:0px;">
...
<%
        ...
        while(iter.hasNext())
        {
            ...
            {
               if(!hideDomainLabel)
                out.println("<div   id=\""+domain.getEtrHashCode()+"\" class=\"simpleNavigationLevel1Selected\" >"+StringUtil.htmlEncode(label)+"</div>");
            ...
            else
            {
                ...
                {
                  out.println("<div  class=\"simpleNavigationLevel1Normal\" ");
