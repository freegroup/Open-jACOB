...
<frameset noresize id=jacob_twinframe rows="0,100%,*" border=0 >
    <frame noresize marginheight=0 marginwidth=0  frameborder=0   scrolling="no"  class="teaser" id=teaser name=teaser  src="teaser.jsp?browser=<%=browserId%>"/>
<%if (control!=null && event !=null) {%>
    <frame noresize marginheight=0 marginwidth=0  frameborder="0" scrolling="no" id=jacob_content1 name=jacob_content1  src="ie_content.jsp?browser=<%=browserId%>&control=<%=control%>&event=<%=event%>"/>
<%} else { %>
    <frame noresize marginheight=0 marginwidth=0  frameborder="0" scrolling="no" id=jacob_content1 name=jacob_content1  src="ie_content.jsp?browser=<%=browserId%>"/>
<%}%>
