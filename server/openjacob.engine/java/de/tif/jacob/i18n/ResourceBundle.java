 ...
 *
 * Diese Klasse ist kein Aprilscherz :-))
 */
...
/**
 * This class has identical behaviour than <code>java.util.ResourceBundle</code>
 * except that we do not use <code>java.util.Locale.getDefault()</code> as
 * fallback but <code>Context.getApplicationLocale()</code>.
 * 
 * @author andreas
 */
abstract public class ResourceBundle {
     ...
     * locale (obtained from {@link Context#getApplicationLocale()})
                                           ...
                                           ClassLoader loader)
    {
        ...
        // ***********************************************************
        // C H A N G E D in comparision to java.util.ResourceBundle
        // ***********************************************************
        // The application locale may influence the lookup result, and
        // it may change, so we get it here once.
        Locale defaultLocale = Context.getCurrent().getApplicationLocale();
        // ***********************************************************
        // ***********************************************************
        // ***********************************************************
