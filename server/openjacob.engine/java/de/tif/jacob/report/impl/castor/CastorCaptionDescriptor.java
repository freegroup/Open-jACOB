...
public class CastorCaptionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CastorCaptionDescriptor() {
        ...
        //-- _expanded
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Boolean.TYPE, "_expanded", "expanded", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                CastorCaption target = (CastorCaption) object;
                if(!target.hasExpanded())
                    return null;
                return (target.getExpanded() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    // if null, use delete method for optional primitives 
                    if (value == null) {
                        target.deleteExpanded();
                        return;
                    }
                    target.setExpanded( ((java.lang.Boolean)value).booleanValue());
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
        //-- _font
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(de.tif.jacob.report.impl.castor.CastorFont.class, "_font", "font", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    CastorCaption target = (CastorCaption) object;
                    target.setFont( (de.tif.jacob.report.impl.castor.CastorFont) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new de.tif.jacob.report.impl.castor.CastorFont();
            }
        } );
        desc.setHandler(handler);
        desc.setMultivalued(false);
        ...
        desc.setValidator(fieldValidator);
    } //-- de.tif.jacob.report.impl.castor.CastorCaptionDescriptor()
    ...
    {
        return de.tif.jacob.report.impl.castor.CastorCaption.class;
