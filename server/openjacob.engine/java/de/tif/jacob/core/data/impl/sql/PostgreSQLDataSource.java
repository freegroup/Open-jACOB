...
import de.tif.jacob.core.adjustment.impl.BooleanAdjustment;
 ...
 * @author Andreas
 */
public final class PostgreSQLDataSource extends SQLDataSource
{
  static public transient final String RCS_ID = "$Id: PostgreSQLDataSource.java,v 1.2 2011/07/02 09:11:32 freegroup Exp $";
  static public transient final String RCS_REV = "$Revision: 1.2 $";

  static private final transient Log logger = LogFactory.getLog(PostgreSQLDataSource.class);
  ...
  private String schemaPrefix="public.";
...
*/
   ...
   * @param parent
   */
  public PostgreSQLDataSource(AutoDetectSQLDataSource parent)
  {
    super(parent);
  }
   ...
   * @throws Exception
   */
  public PostgreSQLDataSource(IDataTableRecord record) throws Exception
  {
    super(record);
    this.getAdjustment().setBooleanAdjustment(new BooleanAdjustment()
    {
   ...
   */
  public PostgreSQLDataSource(String dataSourceName) throws Exception
  {
  ...
  public String toQueryString(Date date)
  {
    ...
    {
      return " timestamp " + SQL.QUOTE + dateFormat.format(date) + SQL.QUOTE + " ";
    }
  }
  ...
  public String toQueryString(Time time)
  {
    synchronized (timeFormat)
    {
      ...
      return " timestamp " + SQL.QUOTE + timeFormat.format(time) + SQL.QUOTE + " ";
    }
  }
  ...
  public String toQueryString(Timestamp timestamp)
  {
    ...
    {
      return " timestamp " + SQL.QUOTE + timestampFormat.format(timestamp) + SQL.QUOTE + " ";
    }
  }
  ...
  {
    return new PostgreSQLReconfigure(this);
  }
   ...
   */
  private static class PostgreSQLReconfigure extends Reconfigure
  {
    /**
     * @param dataSource
     */
    private PostgreSQLReconfigure(SQLDataSource dataSource)
    {
      super(dataSource);
    }
    ...
    {
      return new PostgreSQLModifyColumnCommand(desiredColumn, currentColumn, modifyType, modifyDefault, modifyRequired, modifyAutoGenerated);
    }
    ...
    {
      return new PostgreSQLDropColumnCommand(currentColumn);
    }
    ...
    {
      return new PostgreSQLDropIndexCommand(currentIndex);
    }
    ...
    {
      return new PostgreSQLRenewPrimaryKeyCommand(currentPrimaryKeyDefinition, desiredPrimaryKeyDefinition);
    }
    ...
    {
      return new PostgreSQLDropPrimaryKeyCommand(currentPrimaryKeyDefinition);
    }
  ...
  private static class PostgreSQLModifyColumnCommand extends ModifyColumnCommand
  {
    private PostgreSQLModifyColumnCommand(ISchemaColumnDefinition desiredColumn, ISchemaColumnDefinition currentColumn, boolean modifyType, boolean modifyDefault, boolean modifyRequired, boolean modifyAutoGenerated)
    {
...
//        if (this.modifyRequired)
  ...
  private static class PostgreSQLDropColumnCommand extends DropColumnCommand
  {
    /**
     * @param currentColumn
     */
    private PostgreSQLDropColumnCommand(ISchemaColumnDefinition currentColumn)
    {
      super(currentColumn);
    }
   ...
   */
  private static class PostgreSQLDropIndexCommand extends DropIndexCommand
  {
    /**
     * @param currentIndex
     */
    protected PostgreSQLDropIndexCommand(ISchemaKeyDefinition currentIndex)
    {
      super(currentIndex);
    }
   ...
   * @author Andreas Sonntag
   */
  private static class PostgreSQLRenewPrimaryKeyCommand extends RenewPrimaryKeyCommand
  {
    /**
     * @param currentPrimaryKeyDefinition
     * @param desiredPrimaryKeyDefinition
     */
    protected PostgreSQLRenewPrimaryKeyCommand(ISchemaKeyDefinition currentPrimaryKeyDefinition, ISchemaKeyDefinition desiredPrimaryKeyDefinition)
    {
   ...
   * @author Andreas Sonntag
   */
  private static class PostgreSQLDropPrimaryKeyCommand extends DropPrimaryKeyCommand
  {
    /**
     * @param currentPrimaryKeyDefinition
     */
    protected PostgreSQLDropPrimaryKeyCommand(ISchemaKeyDefinition currentPrimaryKeyDefinition)
    {
