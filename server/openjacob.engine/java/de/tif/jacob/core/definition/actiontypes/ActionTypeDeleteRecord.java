 ...
 */
public class ActionTypeDeleteRecord extends ActionType
{
  static public final transient String RCS_ID = "$Id: ActionTypeDeleteRecord.java,v 1.2 2009/04/03 07:26:04 achim_boeken Exp $";
  static public final transient String RCS_REV = "$Revision: 1.2 $";

  private final boolean needUserConfirmation;
  
  public ActionTypeDeleteRecord(boolean needUserconfirmation)
  {
  ...
  public void onOuterGroupStatusChanged(IActionTypeHandler actionHandler, IClientContext context, IGuiElement target, GroupState status) throws Exception
  {
	...
	{
    DeleteRecord jacobElement = new DeleteRecord();
    jacobElement.setNeedUserConfirmation(this.needUserConfirmation);
    jacobAction.setDeleteRecord(jacobElement);
  }

  public boolean needUserConfirmation()
  {
