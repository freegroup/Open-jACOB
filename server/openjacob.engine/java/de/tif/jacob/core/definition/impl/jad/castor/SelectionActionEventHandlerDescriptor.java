...
/**
 * Class SelectionActionEventHandlerDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class SelectionActionEventHandlerDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SelectionActionEventHandlerDescriptor() {
        super();
        xmlName = "SelectionActionEventHandler";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SelectionActionEventHandler target = (SelectionActionEventHandler) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- de.tif.jacob.core.definition.impl.jad.castor.SelectionActionEventHandlerDescriptor()
    ...
    {
        return de.tif.jacob.core.definition.impl.jad.castor.SelectionActionEventHandler.class;
