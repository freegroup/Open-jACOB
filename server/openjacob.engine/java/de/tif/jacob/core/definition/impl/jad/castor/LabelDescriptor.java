...
public class LabelDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LabelDescriptor() {
        ...
        //-- _nullDefaultValue
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.String.class, "_nullDefaultValue", "nullDefaultValue", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Label target = (Label) object;
                return target.getNullDefaultValue();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Label target = (Label) object;
                    target.setNullDefaultValue( (java.lang.String) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _nullDefaultValue
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            StringValidator typeValidator = new StringValidator();
            typeValidator.setWhiteSpace("preserve");
        ...
        desc.setValidator(fieldValidator);
    } //-- de.tif.jacob.core.definition.impl.jad.castor.LabelDescriptor()
    ...
    {
        return de.tif.jacob.core.definition.impl.jad.castor.Label.class;
