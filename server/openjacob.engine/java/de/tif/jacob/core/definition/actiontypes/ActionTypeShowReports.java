 ...
 */
public class ActionTypeShowReports extends ActionType
{
  static public final transient String RCS_ID = "$Id: ActionTypeShowReports.java,v 1.2 2009/04/03 07:26:04 achim_boeken Exp $";
  static public final transient String RCS_REV = "$Revision: 1.2 $";


  // IBIS: Sollte durch die ApplicationLoader angelegt werden. Im Moment passiert dies in ApplicationFactory (HTML)
	public ActionTypeShowReports()
  {
  }
