 ...
 */
public class ActionTypeGeneric extends ActionType
{
  static public final transient String RCS_ID = "$Id: ActionTypeGeneric.java,v 1.2 2009/04/03 07:26:04 achim_boeken Exp $";
  ...
  public void onOuterGroupStatusChanged(IActionTypeHandler actionHandler, IClientContext context, IGuiElement target, GroupState status) throws Exception
  {
	...
	{
    Generic jacobElement = new Generic();
    jacobAction.setGeneric(jacobElement);
  }
