 ...
 */
public class DateInputFieldDefinition extends LocalInputFieldDefinition
{
  static public final transient String RCS_ID = "$Id: DateInputFieldDefinition.java,v 1.3 2009/02/11 12:18:04 freegroup Exp $";
  static public final transient String RCS_REV = "$Revision: 1.3 $";
  
	public DateInputFieldDefinition(String name, String description,String inputHint, String eventHandler, Dimension position, boolean visible, boolean readonly, int tabIndex, int paneIndex, Caption caption, ITableAlias localTableAlias, ITableField localTableField, FontDefinition font)
	{
	...
	{
    return factory.createDate(app, parent, this); 
  }
	...
	{
    DateInput jacobDateInput = new DateInput();
    jacobLocalInputField.setDateInput(jacobDateInput);
    jacobDateInput.setDimension(getDimension().toJacob());
    if (null != getCaption())
      jacobDateInput.setCaption(getCaption().toJacob());
  }
