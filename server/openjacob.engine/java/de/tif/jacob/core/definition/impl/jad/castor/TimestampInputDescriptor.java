...
/**
 * Class TimestampInputDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class TimestampInputDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TimestampInputDescriptor() {
        super();
        xmlName = "TimestampInput";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                TimestampInput target = (TimestampInput) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- de.tif.jacob.core.definition.impl.jad.castor.TimestampInputDescriptor()
    ...
    {
        return de.tif.jacob.core.definition.impl.jad.castor.TimestampInput.class;
