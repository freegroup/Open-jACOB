...
public class ContainerDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ContainerDescriptor() {
        ...
        //-- _layout
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(de.tif.jacob.core.definition.impl.jad.castor.types.ContainerLayoutType.class, "_layout", "layout", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Container target = (Container) object;
                    target.setLayout( (de.tif.jacob.core.definition.impl.jad.castor.types.ContainerLayoutType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setHandler( new org.exolab.castor.xml.handlers.EnumFieldHandler(de.tif.jacob.core.definition.impl.jad.castor.types.ContainerLayoutType.class, handler));
        desc.setImmutable(true);
        addFieldDescriptor(desc);
        ...
        desc.setValidator(fieldValidator);
        //-- _paneList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(de.tif.jacob.core.definition.impl.jad.castor.CastorGroup.class, "_paneList", "Pane", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Container target = (Container) object;
                return target.getPane();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Container target = (Container) object;
                    target.addPane( (de.tif.jacob.core.definition.impl.jad.castor.CastorGroup) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- validation code for: _paneList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(0);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- de.tif.jacob.core.definition.impl.jad.castor.ContainerDescriptor()
    ...
    {
        return de.tif.jacob.core.definition.impl.jad.castor.Container.class;
