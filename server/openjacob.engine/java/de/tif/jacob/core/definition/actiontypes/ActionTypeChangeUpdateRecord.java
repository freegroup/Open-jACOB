 ...
 */
public class ActionTypeChangeUpdateRecord extends ActionTypeUpdateRecord
{
  static public final transient String RCS_ID = "$Id: ActionTypeChangeUpdateRecord.java,v 1.3 2009/07/17 06:40:24 freegroup Exp $";
  static public final transient String RCS_REV = "$Revision: 1.3 $";

  public ActionTypeChangeUpdateRecord(ExecuteScope scope)
  {
    super(scope);
