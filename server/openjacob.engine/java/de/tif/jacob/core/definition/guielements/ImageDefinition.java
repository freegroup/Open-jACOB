 ...
 */
public class ImageDefinition extends LocalInputFieldDefinition
{
  static public final transient String RCS_ID = "$Id: ImageDefinition.java,v 1.3 2009/02/11 12:18:04 freegroup Exp $";
  static public final transient String RCS_REV = "$Revision: 1.3 $";
  
	public ImageDefinition(String name, String description,String inputHint, String eventHandler, Dimension position, boolean visible, boolean readonly, int tabIndex, int paneIndex, Caption caption, ITableAlias localTableAlias, ITableField localTableField)
	{
	...
	{
    return factory.createImage(app, parent, this); 
  }
	...
	{
    Image jacobImageInput = new Image();
    jacobLocalInputField.setImage(jacobImageInput);
    jacobImageInput.setDimension(getDimension().toJacob());
    if (null != getCaption())
      jacobImageInput.setCaption(getCaption().toJacob());
    // TODO : setInForm correctly
    jacobImageInput.setInForm(false);
  }
