...
/**
 * Class PasswordInputDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class PasswordInputDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PasswordInputDescriptor() {
        super();
        xmlName = "PasswordInput";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                PasswordInput target = (PasswordInput) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- de.tif.jacob.core.definition.impl.jad.castor.PasswordInputDescriptor()
    ...
    {
        return de.tif.jacob.core.definition.impl.jad.castor.PasswordInput.class;
