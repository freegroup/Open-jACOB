 ...
 */
public class TimeInputFieldDefinition extends LocalInputFieldDefinition
{
  static public final transient String RCS_ID = "$Id: TimeInputFieldDefinition.java,v 1.3 2009/02/11 12:18:04 freegroup Exp $";
  static public final transient String RCS_REV = "$Revision: 1.3 $";
  
	public TimeInputFieldDefinition(String name, String description, String inputHint,String eventHandler, Dimension position, boolean visible, boolean readonly, int tabIndex, int paneIndex, Caption caption,
      ITableAlias localTableAlias, ITableField localTableField, FontDefinition font)
  {
	...
	{
    return factory.createTime(app, parent, this); 
  }
	...
	{
    TimeInput jacobTimeInput = new TimeInput();
    jacobLocalInputField.setTimeInput(jacobTimeInput);
    jacobTimeInput.setDimension(getDimension().toJacob());
    if (null != getCaption())
      jacobTimeInput.setCaption(getCaption().toJacob());
  }
