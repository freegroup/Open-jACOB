 ...
 */
public class ActionTypeNewRecord extends ActionType
{
  static public final transient String RCS_ID = "$Id: ActionTypeNewRecord.java,v 1.2 2009/04/03 07:26:04 achim_boeken Exp $";
  static public final transient String RCS_REV = "$Revision: 1.2 $";

  public void execute(IActionTypeHandler actionHandler, IClientContext context, IActionEmitter emitter) throws NoSuchFieldException, Exception
  {
  ...
  public void onOuterGroupStatusChanged(IActionTypeHandler actionHandler, IClientContext context, IGuiElement target, GroupState status) throws Exception
  {
	...
	{
    NewRecord jacobElement = new NewRecord();
    jacobAction.setNewRecord(jacobElement);
  }
