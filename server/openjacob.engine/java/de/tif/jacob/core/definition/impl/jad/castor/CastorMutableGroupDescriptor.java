...
/**
 * Class CastorMutableGroupDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class CastorMutableGroupDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CastorMutableGroupDescriptor() {
        super();
        xmlName = "CastorMutableGroup";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                CastorMutableGroup target = (CastorMutableGroup) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroupDescriptor()
    ...
    {
        return de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup.class;
