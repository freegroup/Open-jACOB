...
import de.tif.jacob.core.definition.ActionType.ExecuteScope;
 ...
 */
public class ActionTypeUpdateRecord extends ActionType
{
  static public final transient String RCS_ID = "$Id: ActionTypeUpdateRecord.java,v 1.3 2009/07/17 06:40:24 freegroup Exp $";
  static public final transient String RCS_REV = "$Revision: 1.3 $";

  private final ExecuteScope scope; 
  
  private ActionTypeUpdateRecord()
  {
    super();
    scope = SCOPE_OUTERGROUP;
  }

  public ActionTypeUpdateRecord(ActionType.ExecuteScope scope)
  {
    super();
    this.scope = scope;
  }
  ...
  {
    actionHandler.onGroupStatusChanged(this, context,target,status);
  }
  ...
  /* (non-Javadoc)
	...
	{
    UpdateRecord jacobElement = new UpdateRecord();
    jacobElement.setChangeUpdate(false);
    jacobAction.setUpdateRecord(jacobElement);
  }
