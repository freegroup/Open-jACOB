...
/**
 * Class CastorMutableForm.
 * 
 * @version $Revision$ $Date$
 */
public class CastorMutableForm implements java.io.Serializable {
    ...
    public CastorMutableForm() {
        super();
        _groupList = new Vector();
        _propertyList = new Vector();
    } //-- de.tif.jacob.core.definition.impl.jad.castor.CastorMutableForm()
     ...
     * @param vGroup
     */
    public void addGroup(de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup vGroup)
        throws java.lang.IndexOutOfBoundsException
    {
        _groupList.addElement(vGroup);
    } //-- void addGroup(de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup) 
     ...
     * @param vGroup
     */
    public void addGroup(int index, de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup vGroup)
        throws java.lang.IndexOutOfBoundsException
    {
        _groupList.insertElementAt(vGroup, index);
    } //-- void addGroup(int, de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup) 
     ...
     * @param index
     */
    public de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup getGroup(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup) _groupList.elementAt(index);
    } //-- de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup getGroup(int) 

    /**
     * Method getGroup
     */
    public de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup[] getGroup()
    {
        int size = _groupList.size();
        de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup[] mArray = new de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup) _groupList.elementAt(index);
        }
        return mArray;
    } //-- de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup[] getGroup() 
     ...
     * @param index
     */
    public de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup removeGroup(int index)
    {
        java.lang.Object obj = _groupList.elementAt(index);
        _groupList.removeElementAt(index);
        return (de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup) obj;
    } //-- de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup removeGroup(int) 
     ...
     * @param vGroup
     */
    public void setGroup(int index, de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup vGroup)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _groupList.size())) {
    ...
    } //-- void setGroup(int, de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup) 
     ...
     * @param groupArray
     */
    public void setGroup(de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup[] groupArray)
    {
        //-- copy array
        _groupList.removeAllElements();
    ...
    } //-- void setGroup(de.tif.jacob.core.definition.impl.jad.castor.CastorMutableGroup) 
    ...
    /**
     * Method unmarshalCastorMutableForm
     * 
     * @param reader
     */
    public static java.lang.Object unmarshalCastorMutableForm(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.tif.jacob.core.definition.impl.jad.castor.CastorMutableForm) Unmarshaller.unmarshal(de.tif.jacob.core.definition.impl.jad.castor.CastorMutableForm.class, reader);
    } //-- java.lang.Object unmarshalCastorMutableForm(java.io.Reader) 
