 ...
 */
public class ActionTypeRecordSelected extends ActionTypeGeneric
{
  static public final transient String RCS_ID = "$Id: ActionTypeRecordSelected.java,v 1.2 2009/04/03 07:26:04 achim_boeken Exp $";
  static public final transient String RCS_REV = "$Revision: 1.2 $";
	...
	{
    RecordSelected jacobElement = new RecordSelected();
    jacobAction.setRecordSelected(jacobElement);
  }
