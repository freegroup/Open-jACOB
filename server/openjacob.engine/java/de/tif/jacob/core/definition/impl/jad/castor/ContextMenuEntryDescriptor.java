...
/**
 * Class ContextMenuEntryDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class ContextMenuEntryDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ContextMenuEntryDescriptor() {
        super();
        xmlName = "ContextMenuEntry";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ContextMenuEntry target = (ContextMenuEntry) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- de.tif.jacob.core.definition.impl.jad.castor.ContextMenuEntryDescriptor()
    ...
    {
        return de.tif.jacob.core.definition.impl.jad.castor.ContextMenuEntry.class;
