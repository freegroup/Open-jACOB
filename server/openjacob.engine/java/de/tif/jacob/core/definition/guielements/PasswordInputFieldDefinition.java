 ...
 */
public class PasswordInputFieldDefinition extends LocalInputFieldDefinition
{
  static public final transient String RCS_ID = "$Id: PasswordInputFieldDefinition.java,v 1.3 2009/02/11 12:18:04 freegroup Exp $";
  static public final transient String RCS_REV = "$Revision: 1.3 $";

	public PasswordInputFieldDefinition(String name, String description,String inputHint, String eventHandler, Dimension position, boolean visible, boolean readonly, int tabIndex, int paneIndex,
  ...
  {
    return factory.createPassword(app, parent,this); 
  }
	...
	{
    PasswordInput jacobPasswordInput = new PasswordInput();
    jacobLocalInputField.setPasswordInput(jacobPasswordInput);
    jacobPasswordInput.setDimension(getDimension().toJacob());
    if (null != getCaption())
      jacobPasswordInput.setCaption(getCaption().toJacob());
  }
}
