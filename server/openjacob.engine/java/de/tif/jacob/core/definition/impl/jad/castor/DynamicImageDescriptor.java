 ...
 */
public class DynamicImageDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DynamicImageDescriptor() {
        super();
        xmlName = "DynamicImage";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                DynamicImage target = (DynamicImage) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- de.tif.jacob.core.definition.impl.jad.castor.DynamicImageDescriptor()
    ...
    {
        return de.tif.jacob.core.definition.impl.jad.castor.DynamicImage.class;
