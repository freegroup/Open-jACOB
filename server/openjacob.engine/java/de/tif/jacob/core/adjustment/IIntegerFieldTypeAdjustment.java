 ...
 */
public interface IIntegerFieldTypeAdjustment
{
	public static final String RCS_ID = "$Id: IIntegerFieldTypeAdjustment.java,v 1.3 2009/01/13 15:31:57 ibissw Exp $";
