 ...
 */
public class EnumerationAdjustment implements IEnumerationFieldTypeAdjustment
{
  /* (non-Javadoc)
  ...
  {
    sqlQuery.append(dataSource.convertToSQL(value, true));
  }
  ...
  {
    return ((EnumerationFieldType) fieldType).getMaxLength();
  }
  ...
  {
    return ((EnumerationFieldType) fieldType).getDefaultValue();
  }
