...
import de.tif.jacob.core.data.impl.DataAutoKeyLongValue;
 ...
 */
public final class LongAdjustment implements ILongFieldTypeAdjustment, IDataNewKeysCreator
{
	static public final transient String RCS_ID = "$Id: LongAdjustment.java,v 1.3 2009/01/13 15:31:57 ibissw Exp $";
  ...
  public Object newKey(DataSource dataSource, ITableDefinition table, ITableField field, boolean dbIncrement, IDataNewKeysCache newKeysCache) throws Exception
  {
    if (dbIncrement && dataSource.supportsAutoKeyGeneration())
      return new DataAutoKeyLongValue();
