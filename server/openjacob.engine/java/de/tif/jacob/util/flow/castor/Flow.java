 ...
 * Schema.
 * $Id: Flow.java,v 1.3 2011/07/01 21:23:55 freegroup Exp $
 */
...
public class Flow implements java.io.Serializable {
    ...
    } //-- de.tif.jacob.util.flow.castor.Flow()
     ...
     * @param reader
     */
    public static java.lang.Object unmarshalFlow(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.tif.jacob.util.flow.castor.Flow) Unmarshaller.unmarshal(de.tif.jacob.util.flow.castor.Flow.class, reader);
    } //-- java.lang.Object unmarshalFlow(java.io.Reader) 
