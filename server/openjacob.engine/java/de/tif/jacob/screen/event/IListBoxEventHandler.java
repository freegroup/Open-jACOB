...
/**
 * Abstract event handler class for list boxes. Derived implementations of this
 * event handler class have to be used to "hook" application-specific business
 * logic to list boxes.
 * 
 * @author Andreas Herz
 */
public abstract class IListBoxEventHandler extends IGroupMemberEventHandler
{
  /**
   * The internal revision control system id.
   */
  static public final transient String RCS_ID = "$Id: IListBoxEventHandler.java,v 1.1 2007/01/19 09:50:40 freegroup Exp $";
  ...
  public final void onGroupStatusChanged(IClientContext context, GroupState state, IGuiElement element) throws Exception
  {
    ...
    //
    onGroupStatusChanged(context,state,(IListBox)element);
  }
   ...
   */
  public abstract void onGroupStatusChanged(IClientContext context, GroupState state, IListBox listBox) throws Exception;
   ...
   *          the listbox itself
   */
  public abstract void onSelect(IClientContext context, IListBox listBox) throws Exception;
}
