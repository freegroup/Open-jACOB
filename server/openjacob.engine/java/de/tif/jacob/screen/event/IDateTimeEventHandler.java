 ...
 * @author Andreas Herz
 */
public abstract class IDateTimeEventHandler extends IGroupMemberEventHandler
{
  /**
   * The internal revision control system id.
   */
  static public final transient String RCS_ID = "$Id: IDateTimeEventHandler.java,v 1.1 2007/12/05 11:25:19 freegroup Exp $";
  ...
  public final void onGroupStatusChanged(IClientContext context, GroupState state, IGuiElement element) throws Exception
  {
    ...
    this.onGroupStatusChanged(context, state,(IDateTime) element);
  }

  public void onGroupStatusChanged(IClientContext context, GroupState state, IDateTime element) throws Exception
  {
  }
}
