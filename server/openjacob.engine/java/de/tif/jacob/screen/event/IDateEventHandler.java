 ...
 * @author Andreas Herz
 */
public abstract class IDateEventHandler extends IGroupMemberEventHandler
{
  /**
   * The internal revision control system id.
   */
  static public final transient String RCS_ID = "$Id: IDateEventHandler.java,v 1.2 2008/12/01 21:06:35 ibissw Exp $";
  ...
  public final void onGroupStatusChanged(IClientContext context, GroupState state, IGuiElement element) throws Exception
  {
    ...
    this.onGroupStatusChanged(context, state,(IDate) element);
  }

  public void onGroupStatusChanged(IClientContext context, GroupState state, IDate element) throws Exception
  {
  }
}
