 ...
 *
 */
public interface IRadioButtonGroup extends ISingleDataGuiElement
{
  static public final String RCS_ID = "$Id: IRadioButtonGroup.java,v 1.4 2009/04/24 14:53:52 freegroup Exp $";
   ...
   * been changed. Non of the entries generates a server request per default.<br>
   * <br>
