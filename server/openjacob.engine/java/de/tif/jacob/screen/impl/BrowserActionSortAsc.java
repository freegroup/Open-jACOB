 ...
 * @author Andras Herz
 */
public class BrowserActionSortAsc extends BrowserAction
{

  public String getLabelId()
  {
    return "BROWSER_ACTION_TOOLTIP_SORT_ASC";
  }
  ...
  public void execute(IClientContext context, IBrowser b, String value) throws Exception
  {
    ...
    IDataBrowserSortStrategy sortStrategy = browser.getDataInternal().newGuiSortStrategy(context.getLocale());
    sortStrategy.add(index, SortOrder.ASCENDING);
