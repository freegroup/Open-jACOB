 ...
 * @author Andras Herz
 */
public class BrowserActionShiftRightReportColumn extends BrowserAction
{
  /* 
  ...
  {
    return "report_column_right.png";
  }


  public String getLabelId()
  {
    return "BUTTON_COMMON_SHIFTRIGHT";
  }
  ...
  public void execute(IClientContext context, IBrowser browser, String value)  throws Exception
  {
    ...
    if((index+1)<reportBrowser.getBrowserTableFields().size() )
    {
      IBrowserTableField field =reportBrowser.removeColumn(index);
      reportBrowser.addColumn(index+1, field);
    }
  }
}
