 ...
 * @author Andras Herz
 */
public class BrowserActionUpdate extends BrowserAction
{
  /* 
  ...
  {
    return "BROWSER_ACTION_TOOLTIP_UPDATE";
  }
  ...
  {
    ((HTTPInFormBrowser)browser).setSelectedRecordIndex(context,Integer.parseInt(value));
  }
