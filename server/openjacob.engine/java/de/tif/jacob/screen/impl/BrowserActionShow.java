 ...
 *
 */
public class BrowserActionShow extends BrowserAction
{
  public static final String ACTION_ID= "showBrowser";
  public String getId()
  {
    return ACTION_ID;
  }
  ...
  {
    return "BROWSER_ACTION_TOOLTIP_SHOW";
  }
  ...
  {
    context.getForm().setCurrentBrowser(browser);
  }
