 ...
 * 
 * Created on Thu Mar 08 15:06:33 CET 2007
 */
 ...
 *
 */
public class CompositionDeleteRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: CompositionDeleteRecordButton.java,v 1.1 2007/03/09 16:42:08 herz Exp $";
    ...
    button.setVisible(context.getSelectedRecord()!=null && status == IGuiElement.SELECTED);
	}
}
