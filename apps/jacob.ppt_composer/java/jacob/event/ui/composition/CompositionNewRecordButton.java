 ...
 * 
 * Created on Thu Mar 08 15:06:37 CET 2007
 */
...
/**
 * The event handler for the CompositionNewRecordButton new button.<br>
 * 
 * @author andherz
 */
public class CompositionNewRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: CompositionNewRecordButton.java,v 1.2 2007/10/02 10:53:07 herz Exp $";
    ...
    ((IButton)button).setLabel("Neu");
    button.setVisible(status != IGuiElement.UPDATE);
	}
}
