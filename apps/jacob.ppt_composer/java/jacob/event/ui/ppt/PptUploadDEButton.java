 ...
 * 
 * Created on Thu Mar 08 11:43:38 CET 2007
 */
...
/**
 * The event handler for the PptUploadDEButton record selected button.<br>
 * The {@link onAction(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * Insert your custom code within this method.<br>
 * 
 * @author andherz
 */
public class PptUploadDEButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: PptUploadDEButton.java,v 1.1 2007/03/09 16:42:08 herz Exp $";
	...
	public void onAction(IClientContext context, IGuiElement button) throws Exception
	{
		context.createUploadDialog(new IUploadDialogCallback() 
		{
			public void onOk(IClientContext context, String fileName, byte[] fileData)throws Exception 
			{
				...
				context.getSelectedRecord().setDocumentValue(trans, Ppt.document_de, DataDocumentValue.create(fileName, fileData));
				((Document)context.getGroup().findByName("pptDocumentDE")).setValue(context, context.getSelectedRecord());
			}
