...
public class SearchToolbar extends Toolbar
{
  ...
  public void writeHTML(ClientContext context, Writer w) throws IOException
  {
     ...
     w.write("<input class=\"text_normal editable_inputfield\" style=\"width:200px\" id=\"searchbar_text\" type=\"text\" value=\""+lastSearchString+"\"></input><button class=\"button_normal\" onclick=\"FireEventData('"+this.getId()+"','search',$F('searchbar_text'))\">Suchen</button>");
     w.write("</div>\n");
  ...
  public boolean processEvent(IClientContext context, int guid, String event, String value) throws Exception
  {
    ...
    //
    Form form = (Form)context.getApplication().findByName("common_search");
