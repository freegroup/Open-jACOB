...
{
	static public final transient String RCS_ID = "$Id: AccountSetPasswordButton.java,v 1.1 2010-08-03 13:54:18 herz Exp $";
    ...
    if(StringUtil.saveEquals(p1,p2) && !StringUtil.emptyOrNull(p1))
    {
      ...
      alert("Kennwort gesetzt. Sie können sich jetzt anmelden.");
    }
    else
    {
