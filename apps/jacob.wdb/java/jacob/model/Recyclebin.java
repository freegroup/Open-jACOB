...
public final class Recyclebin
{
    ...
    * type:     <b>LONG</b><br>
    **/
   public final static String  object_pkey = "object_pkey";
    ...
    * type:     <b>TEXT</b><br>
    **/
   public final static String  object_path = "object_path";
    ...
    * type:     <b>INTEGER</b><br>
    **/
   public final static String  children_count = "children_count";
   
     
           
   public final static class object_type_ENUM
   {
      private object_type_ENUM(){};
      public final static String _menutree = "menutree";
      public final static String _article = "article";
   }
