 ...
 *
 **/
public final class Menutree_parent
{
   private Menutree_parent(){}

   // the name of the table alias    
   public final static String NAME = "menutree_parent";
     
   // All field names of the table alias "menutree_parent"
   /** 
    * <br>
    * <br>
