 ...
 *
 **/
public final class Active_menutree_parent
{
   private Active_menutree_parent(){}

   // the name of the table alias    
   public final static String NAME = "active_menutree_parent";
     
   // All field names of the table alias "active_menutree_parent"
   /** 
    * <br>
    * <br>
