...
/**
 * wird in der Bearbeitungsmaske für den Artikel benötigt. Kommst sonst zu Konflikten mit dem EDIT InformBrowser
 *
 * Condition: <b></b>
 * DB table: <b>attachment</b>
 *
 **/
public final class Attachment_show
{
   private Attachment_show(){}

   // the name of the table alias    
   public final static String NAME = "attachment_show";
     
   // All field names of the table alias "attachment_show"
   /** 
    * <br>
    * <br>
