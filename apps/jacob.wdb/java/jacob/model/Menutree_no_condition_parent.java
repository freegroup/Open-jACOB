 ...
 *
 **/
public final class Menutree_no_condition_parent
{
   private Menutree_no_condition_parent(){}

   // the name of the table alias    
   public final static String NAME = "menutree_no_condition_parent";
     
   // All field names of the table alias "menutree_no_condition_parent"
   /** 
    * <br>
    * <br>
