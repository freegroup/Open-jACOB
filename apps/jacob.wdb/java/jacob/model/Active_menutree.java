 ...
 * 
 *
 * Condition: <b>active_menutree.state ='active' AND active_menutree.lifecycle ='alive'</b>
 * DB table: <b>menutree</b>
 *
 **/
public final class Active_menutree
{
   private Active_menutree(){}

   // the name of the table alias    
   public final static String NAME = "active_menutree";
     
   // All field names of the table alias "active_menutree"
   /** 
    * <br>
    * <br>
