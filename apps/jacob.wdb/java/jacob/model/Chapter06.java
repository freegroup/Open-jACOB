...
public final class Chapter06
{
   ...
   public final static String NAME = "chapter06";
     
   // All field names of the table alias "chapter06"
   /** 
    * <br>
    * <br>
    ...
    * type:     <b>ENUM</b><br>
    **/
   public final static String  author_type = "author_type";
   ...
   public final static class author_type_ENUM
   {
      private author_type_ENUM(){};
      public final static String _user = "user";
      public final static String _script = "script";
   }
