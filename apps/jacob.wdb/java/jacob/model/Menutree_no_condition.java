 ...
 *
 **/
public final class Menutree_no_condition
{
   private Menutree_no_condition(){}

   // the name of the table alias    
   public final static String NAME = "menutree_no_condition";
     
   // All field names of the table alias "menutree_no_condition"
   /** 
    * <br>
    * <br>
