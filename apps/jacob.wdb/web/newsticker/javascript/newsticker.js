var Ticker = new Class({
   ...
   initialize: function(el,options){
      ...
      this.el = $(el);
      this.items = this.el.getElements('li.news_item');
      var w = 0;
      var h = 0;
...
var request = new Ajax('rpc/getNewsCRC32.jsp',
{
   onComplete: function(response) 
   {
      if(crc32 !=response.trim())
      {
...
window.addEvent('domready', function() {
   var t = new Ticker('TickerVertical', {
      speed : 4000, delay : 5000, direction : 'vertical'});
   ...
   // den Ticker alle 15 Sekunden überprüfen
   checkReload.periodical(10000);
});