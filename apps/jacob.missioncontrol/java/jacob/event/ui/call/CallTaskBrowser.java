 ...
 *
 */
public class CallTaskBrowser extends de.tif.jacob.screen.event.IBrowserEventHandler
{
  static public final transient String RCS_ID = "$Id: CallTaskBrowser.java,v 1.2 2005/08/09 16:10:54 mike Exp $";
  ...
  {
      context.getDataAccessor().propagateRecord(selectedRecord,Filldirection.BOTH);
      context.setCurrentForm("task");
