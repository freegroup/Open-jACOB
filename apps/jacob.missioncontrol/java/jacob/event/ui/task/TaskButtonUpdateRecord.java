 ...
 * 
 * Created on Tue Aug 09 15:43:44 CEST 2005
 *
 */
 ...
 *
 */
public class TaskButtonUpdateRecord extends IActionButtonEventHandler 
{
  static public final transient String RCS_ID = "$Id: TaskButtonUpdateRecord.java,v 1.3 2005/09/15 20:01:44 sonntag Exp $";
   ...
   */
	public void onGroupStatusChanged(IClientContext context, GroupState status,	IGuiElement button) throws Exception 
	{
	 if (status == IGuiElement.SELECTED)
         button.setEnable(!ENUM.TASKSTATUS_CLOSED.equals(context.getSelectedRecord().getSaveStringValue("status")));
	}
}
