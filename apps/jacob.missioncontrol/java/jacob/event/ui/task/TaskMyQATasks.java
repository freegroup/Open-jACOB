 ...
 * 
 * Created on Mon Aug 08 12:10:28 CEST 2005
 *
 */
...
import de.tif.jacob.screen.event.IButtonEventHandler;
 ...
 /**
  * The Event handler for the TaskMyQATasks-Button.<br>
  ...
  *
  */
public class TaskMyQATasks extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: TaskMyQATasks.java,v 1.3 2005/09/15 20:01:44 sonntag Exp $";
 	...
 	public void onAction(IClientContext context, IGuiElement button) throws Exception
  {
          ...
          IDataTable    taskTable        = context.getDataTable();     // the table in which the actions performes
        IDataTable     callTable = accessor.getTable("call"); //  the call table from  to perform a constraint
...
//   Meister wollen einen Clear Focus vorab!
        context.clearDomain();
         ...
         // set  search criteria
         taskTable.qbeSetValue("status",ENUM.TASKSTATUS_DONE );
         ...
         //
         browser.search("call",Filldirection.BOTH);
