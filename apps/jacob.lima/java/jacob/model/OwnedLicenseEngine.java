...
public final class OwnedLicenseEngine
{
   private OwnedLicenseEngine(){}

   // the name of the table alias	 
   public final static String NAME = "ownedLicenseEngine";
	 
   // All field names of the table alias "ownedLicenseEngine"
   /** 
     required: true<br>
     type:     LONG<br>
   */
