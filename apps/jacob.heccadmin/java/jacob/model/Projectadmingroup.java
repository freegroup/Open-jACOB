 ...
 * 
 *
 * Condition: <b>projectadmingroup.datedeleted IS NULL</b>
 * DB table: <b>ldapgroup</b>
 *
 **/
public final class Projectadmingroup
{
   private Projectadmingroup(){}

   // the name of the table alias	 
   public final static String NAME = "projectadmingroup";
	 
   // All field names of the table alias "projectadmingroup"
   /** 
    * <br>
    * <br>
