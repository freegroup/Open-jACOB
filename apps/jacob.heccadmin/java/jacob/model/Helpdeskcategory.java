 ...
 *
 **/
public final class Helpdeskcategory
{
   private Helpdeskcategory(){}

   // the name of the table alias	 
   public final static String NAME = "helpdeskcategory";
	 
   // All field names of the table alias "helpdeskcategory"
   /** 
    * <br>
    * <br>
    ...
    * type:     <b>TEXT</b><br>
    **/
   public final static String  rootcategory_key = "rootcategory_key";
