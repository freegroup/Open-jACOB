 ...
 * 
 *
 * Condition: <b>ldapparentgroup.datedeleted IS NULL</b>
 * DB table: <b>ldapgroup</b>
 *
 **/
public final class Ldapparentgroup
{
   private Ldapparentgroup(){}

   // the name of the table alias	 
   public final static String NAME = "ldapparentgroup";
	 
   // All field names of the table alias "ldapparentgroup"
   /** 
    * <br>
    * <br>
