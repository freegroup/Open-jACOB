 ...
 * 
 * Created on Thu Nov 27 12:07:03 CET 2008
 */
...
/**
 * The event handler for the ProjectAddLanguagesButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * 
 * @author R.Spoor
 */
public class ProjectAddLanguagesButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProjectAddLanguagesButton.java,v 1.1 2009/02/17 15:23:29 R.Spoor Exp $";
