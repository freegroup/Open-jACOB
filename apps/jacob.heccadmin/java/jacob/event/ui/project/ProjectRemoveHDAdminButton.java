 ...
 * 
 * Created on Thu Dec 18 15:23:36 CET 2008
 */
...
/**
 * The event handler for the ProjectRemoveAdminButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * 
 * @author R.Spoor
 */
public class ProjectRemoveHDAdminButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProjectRemoveHDAdminButton.java,v 1.1 2009/02/17 15:23:29 R.Spoor Exp $";
