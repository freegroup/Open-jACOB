 ...
 * 
 * Created on Thu Dec 18 15:14:20 CET 2008
 */
...
/**
 * The event handler for the ProjectRemoveUserGroupsButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * 
 * @author R.Spoor
 */
public class ProjectRemoveUserGroupsButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProjectRemoveUserGroupsButton.java,v 1.1 2009/02/17 15:23:29 R.Spoor Exp $";
