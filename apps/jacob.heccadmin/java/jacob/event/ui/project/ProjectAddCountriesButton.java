 ...
 * 
 * Created on Thu Nov 27 12:03:56 CET 2008
 */
...
/**
 * The event handler for the ProjectAddCountriesButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * Insert your custom code within this method.<br>
 * 
 * @author R.Spoor
 */
public class ProjectAddCountriesButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProjectAddCountriesButton.java,v 1.1 2009/02/17 15:23:29 R.Spoor Exp $";
