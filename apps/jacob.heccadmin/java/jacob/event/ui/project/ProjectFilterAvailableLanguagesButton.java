 ...
 * 
 * Created on Wed Dec 10 14:59:51 CET 2008
 */
...
/**
 * The event handler for the ProjectFilterAvailableLanguagesButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * 
 * @author R.Spoor
 */
public class ProjectFilterAvailableLanguagesButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProjectFilterAvailableLanguagesButton.java,v 1.1 2009/02/17 15:23:29 R.Spoor Exp $";
    ...
    static void filterAvailableLanguages(IClientContext context) throws Exception
    {
        IGroup group = context.getGroup();
        String filter = group.getInputFieldValue("projectFilterAvailableLanguagesText");
        ...
        available.setOptions(languages.toArray(entries));
    }
	...
	{
	    filterAvailableLanguages(context);
	}
