 ...
 * 
 * Created on Tue Jan 20 14:39:15 CET 2009
 */
...
/**
 * The event handler for the ProjectFilterAvailablePowerUserGroupsButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * 
 * @author R.Spoor
 */
public class ProjectFilterAvailablePowerUserGroupsButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProjectFilterAvailablePowerUserGroupsButton.java,v 1.1 2009/02/17 15:23:29 R.Spoor Exp $";
    ...
    static void filterAvailableGroups(IClientContext context) throws Exception
    {
        ...
        String filter = group.getInputFieldValue("projectFilterAvailablePowerUserGroupsText");
