 ...
 * 
 * Created on Tue Jan 20 14:42:42 CET 2009
 */
...
/**
 * The event handler for the ProjectRemovePowerUserGroupsButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * 
 * @author R.Spoor
 */
public class ProjectRemovePowerUserGroupsButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProjectRemovePowerUserGroupsButton.java,v 1.1 2009/02/17 15:23:32 R.Spoor Exp $";
    ...
    public void onClick(IClientContext context, IGuiElement emitter) throws Exception
    {
        ...
        IMutableListBox available = (IMutableListBox)group.findByName("projectAvailablePowerUserGroupsListbox");
        ListBoxUtil.removeSelection(
            context, selected, available, currentRecord, Project.pkey,
            Projectpowerusergroup.groupname, Projectpowerusergroup_MN.NAME,
            Projectpowerusergroup_MN.project_key, Projectpowerusergroup_MN.groupname
        );
        ProjectFilterSelectedPowerUserGroupsButton.filterSelectedGroups(context);
        ProjectFilterAvailablePowerUserGroupsButton.filterAvailableGroups(context);
	}
