 ...
 * 
 * Created on Thu Dec 18 15:14:43 CET 2008
 */
...
/**
 * The event handler for the ProjectFilterSelectedUserGroupsButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * Insert your custom code within this method.<br>
 * 
 * @author R.Spoor
 */
public class ProjectFilterSelectedUserGroupsButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProjectFilterSelectedUserGroupsButton.java,v 1.1 2009/02/17 15:23:29 R.Spoor Exp $";
	...
	static void filterSelectedGroups(IClientContext context) throws Exception
	{
        ...
        String filter = group.getInputFieldValue("projectFilterSelectedUserGroupsText");
