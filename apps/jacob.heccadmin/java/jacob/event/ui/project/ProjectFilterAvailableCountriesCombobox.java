 ...
 * 
 * Created on Wed Dec 10 14:53:55 CET 2008
 */
 ...
 * @author R.Spoor
 */
public class ProjectFilterAvailableCountriesCombobox extends IMutableComboBoxEventHandler
{
	static public final transient String RCS_ID = "$Id: ProjectFilterAvailableCountriesCombobox.java,v 1.1 2009/02/17 15:23:32 R.Spoor Exp $";
	...
	static void filterAvailableCountries(IClientContext context,
	       ...
	       throws Exception
	{
        ...
        available.setOptions(countries.toArray(entries));
	}
	...
	{
	    filterAvailableCountries(context, comboBox);
	}
