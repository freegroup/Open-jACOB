...
/**
 * The event handler for the ProjectFilterSelectedAdminGroupsButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * 
 * @author R.Spoor
 */
public class ProjectFilterSelectedAdminGroupsButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProjectFilterSelectedAdminGroupsButton.java,v 1.1 2009/02/17 15:23:29 R.Spoor Exp $";
    ...
    static void filterSelectedGroups(IClientContext context) throws Exception
    {
        ...
        String filter = group.getInputFieldValue("projectFilterSelectedAdminGroupsText");
