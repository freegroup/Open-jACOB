 ...
 * 
 * Created on Tue Jan 20 14:34:09 CET 2009
 */
...
/**
 * The event handler for the ProjectRemoveAdminGroupsButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * 
 * @author R.Spoor
 */
public class ProjectRemoveAdminGroupsButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProjectRemoveAdminGroupsButton.java,v 1.1 2009/02/17 15:23:32 R.Spoor Exp $";
