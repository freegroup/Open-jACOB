 ...
 * 
 * Created on Tue Jan 20 14:41:13 CET 2009
 */
...
/**
 * The event handler for the ProjectAddPowerUserGroupsButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * 
 * @author R.Spoor
 */
public class ProjectAddPowerUserGroupsButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: ProjectAddPowerUserGroupsButton.java,v 1.1 2009/02/17 15:23:32 R.Spoor Exp $";
