 ...
 * 
 * Created on Wed Jan 28 16:17:58 CET 2009
 */
package jacob.event.ui.language;
...
/**
 * The event handler for the LanguageUpdateRecordButton update button.<br>
 * 
 * @author R.Spoor
 */
public class LanguageUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: LanguageUpdateRecordButton.java,v 1.1 2009/02/17 15:23:37 R.Spoor Exp $";
