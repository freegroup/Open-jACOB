 ...
 * 
 * Created on Wed Jan 28 16:52:50 CET 2009
 */
package jacob.event.ui.sacrouting;
...
/**
 * The event handler for the SacroutingUpdateRecordButton update button.<br>
 * 
 * @author R.Spoor
 */
public class SacroutingUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: SacroutingUpdateRecordButton.java,v 1.1 2009/02/17 15:23:37 R.Spoor Exp $";
