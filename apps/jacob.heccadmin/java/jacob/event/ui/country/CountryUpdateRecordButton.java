 ...
 * 
 * Created on Wed Jan 28 16:15:52 CET 2009
 */
package jacob.event.ui.country;
...
/**
 * The event handler for the CountryUpdateRecordButton update button.<br>
 * 
 * @author R.Spoor
 */
public class CountryUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: CountryUpdateRecordButton.java,v 1.1 2009/02/17 15:23:44 R.Spoor Exp $";
