 ...
 * 
 * Created on Wed Jan 28 17:11:15 CET 2009
 */
...
/**
 * The event handler for the NumberNewRecordButton new button.<br>
 * 
 * @author R.Spoor
 */
public class NumberNewRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: NumberNewRecordButton.java,v 1.1 2009/02/17 15:23:42 R.Spoor Exp $";
