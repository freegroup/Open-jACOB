 ...
 * 
 * Created on Wed Jan 28 17:12:16 CET 2009
 */
 ...
 * @author R.Spoor
 */
 public class NumberGroup extends IGroupEventHandler 
 {
	static public final transient String RCS_ID = "$Id: NumberGroup.java,v 1.1 2009/02/17 15:23:42 R.Spoor Exp $";
    ...
    public void onShow(IClientContext context, IGroup group) throws Exception 
    {
        ...
        {
            IGuiElement element = group.findByName("numberHistory");
