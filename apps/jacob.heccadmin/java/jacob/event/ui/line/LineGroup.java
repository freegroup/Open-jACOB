 ...
 * 
 * Created on Wed Jan 28 17:03:38 CET 2009
 */
 ...
 * @author R.Spoor
 */
 public class LineGroup extends IGroupEventHandler 
 {
	static public final transient String RCS_ID = "$Id: LineGroup.java,v 1.1 2009/02/17 15:23:36 R.Spoor Exp $";
    ...
    public void onShow(IClientContext context, IGroup group) throws Exception 
    {
        ...
        {
            IGuiElement element = group.findByName("lineHistory");
