 ...
 * 
 * Created on Thu Nov 27 12:27:34 CET 2008
 */
...
/**
 * The event handler for the CountrygroupRemoveCountriesButton generic button.<br>
 * The {@link #onClick(IClientContext, IGuiElement)} will be called, if the user clicks on this button.
 * 
 * @author R.Spoor
 */
public class CountrygroupRemoveCountriesButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: CountrygroupRemoveCountriesButton.java,v 1.1 2009/02/17 15:23:43 R.Spoor Exp $";
