 ...
 *
 * Created on Thu Mar 19 11:39:19 CET 2009
 */
 ...
 * @author R.Spoor
 */
 public class EmailqueuedetailsServicelevelText extends ITextFieldEventHandler
 {
	static public final transient String RCS_ID = "$Id: EmailqueuedetailsServicelevelText.java,v 1.1 2009/03/19 11:00:18 R.Spoor Exp $";
    ...
    public void onGroupStatusChanged(IClientContext context, GroupState state, IText text) throws Exception
    {
        ...
        text.setValue((record == null ? null : record.getStringValue(Emailqueue.servicelevel)));
    }
}
