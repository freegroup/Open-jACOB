 ...
 * 
 * Created on Wed Jan 28 16:19:27 CET 2009
 */
package jacob.event.ui.irissymptom;
...
/**
 * The event handler for the IrissymptomUpdateRecordButton update button.<br>
 * 
 * @author R.Spoor
 */
public class IrissymptomUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: IrissymptomUpdateRecordButton.java,v 1.1 2009/02/17 15:23:45 R.Spoor Exp $";
