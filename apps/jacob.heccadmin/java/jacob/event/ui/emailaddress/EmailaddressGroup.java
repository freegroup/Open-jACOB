 ...
 * 
 * Created on Wed Jan 28 17:05:14 CET 2009
 */
 ...
 * @author R.Spoor
 */
 public class EmailaddressGroup extends IGroupEventHandler 
 {
	static public final transient String RCS_ID = "$Id: EmailaddressGroup.java,v 1.1 2009/02/17 15:23:38 R.Spoor Exp $";
    ...
    public void onShow(IClientContext context, IGroup group) throws Exception 
    {
        ...
        {
            IGuiElement element = group.findByName("emailaddressHistory");
