 ...
 * 
 * Created on Wed Jan 28 16:54:04 CET 2009
 */
package jacob.event.ui.emailaddress;
...
/**
 * The event handler for the EmailaddressUpdateRecordButton update button.<br>
 * 
 * @author R.Spoor
 */
public class EmailaddressUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: EmailaddressUpdateRecordButton.java,v 1.1 2009/02/17 15:23:38 R.Spoor Exp $";
