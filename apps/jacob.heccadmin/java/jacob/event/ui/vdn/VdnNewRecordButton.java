...
/**
 * The event handler for the VdnNewRecordButton new button.<br>
 * 
 * @author R.Spoor
 */
public class VdnNewRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: VdnNewRecordButton.java,v 1.1 2009/02/17 15:23:40 R.Spoor Exp $";
