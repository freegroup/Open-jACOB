 ...
 * 
 * Created on Fri Dec 12 11:39:58 CET 2008
 */
 ...
 * @author R.Spoor
 */
 public class VdnGroup extends IGroupEventHandler 
 {
	static public final transient String RCS_ID = "$Id: VdnGroup.java,v 1.1 2009/02/17 15:23:40 R.Spoor Exp $";
	...
	{
        ISingleDataGuiElement line = (ISingleDataGuiElement)group.findByName("vdnLine");
    ...
    public void onShow(IClientContext context, IGroup group) throws Exception 
    {
        ...
        {
            IGuiElement element = group.findByName("vdnHistory");
