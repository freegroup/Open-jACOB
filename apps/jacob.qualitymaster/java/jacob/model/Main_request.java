 ...
 *
 **/
public final class Main_request
{
   private Main_request(){}

   // the name of the table alias    
   public final static String NAME = "main_request";
     
   // All field names of the table alias "main_request"
   /** 
    * <br>
    * <br>
    ...
    * type:     <b>INTEGER</b><br>
    **/
   public final static String  creater_key = "creater_key";
    ...
    * type:     <b>INTEGER</b><br>
    **/
   public final static String  tester_key = "tester_key";
    ...
    * type:     <b>INTEGER</b><br>
    **/
   public final static String  main_request_key = "main_request_key";
    ...
    * type:     <b>INTEGER</b><br>
    **/
   public final static String  suspend_from_rellist = "suspend_from_rellist";
   ...
   public final static class state_ENUM
   {
      ...
      public final static String _Proved = "Proved";
      ...
      public final static String _Obsolete = "Obsolete";
      public final static String _Declined = "Declined";
      public final static String _Duplicate = "Duplicate";
   }
   ...
   public final static class type_ENUM
   {
      ...
      public final static String _Change_Req = "Change Req";
      public final static String _Enhancement_Req = "Enhancement Req";
   }
