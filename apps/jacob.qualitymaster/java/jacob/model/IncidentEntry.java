...
/**
 * Mandatorsicht auf die Incidents
 *
 * Condition: <b>incidentEntry.organization_key={MANDATORID}</b>
 * DB table: <b>incident</b>
 *
 **/
public final class IncidentEntry
{
   private IncidentEntry(){}

   // the name of the table alias    
   public final static String NAME = "incidentEntry";
     
   // All field names of the table alias "incidentEntry"
   /** 
    * <br>
    * <br>
