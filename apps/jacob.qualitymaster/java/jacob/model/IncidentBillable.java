 ...
 * 
 *
 * Condition: <b>incidentBillable.incident_budget_key is not NULL</b>
 * DB table: <b>incident</b>
 *
 **/
public final class IncidentBillable
{
   private IncidentBillable(){}

   // the name of the table alias    
   public final static String NAME = "incidentBillable";
     
   // All field names of the table alias "incidentBillable"
   /** 
    * <br>
    * <br>
