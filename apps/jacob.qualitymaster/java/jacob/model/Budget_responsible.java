 ...
 * 
 *
 * Condition: <b>budget_responsible.organization_key={MANDATORID}</b>
 * DB table: <b>employee</b>
 *
 **/
public final class Budget_responsible
{
   private Budget_responsible(){}

   // the name of the table alias    
   public final static String NAME = "budget_responsible";
     
   // All field names of the table alias "budget_responsible"
   /** 
    * <br>
    * <br>
