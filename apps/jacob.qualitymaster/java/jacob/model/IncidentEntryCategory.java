 ...
 * 
 *
 * Condition: <b>(([orgcategory].organization_key={MANDATORID} AND incidentEntryCategory.global=0) OR incidentEntryCategory.global=1) AND incidentEntryCategory.state='open'</b>
 * DB table: <b>category</b>
 *
 **/
public final class IncidentEntryCategory
{
   private IncidentEntryCategory(){}

   // the name of the table alias    
   public final static String NAME = "incidentEntryCategory";
     
   // All field names of the table alias "incidentEntryCategory"
   /** 
    * <br>
    * <br>
