 ...
 * 
 *
 * Condition: <b>incidentCategory.state='open'</b>
 * DB table: <b>category</b>
 *
 **/
public final class IncidentCategory
{
   private IncidentCategory(){}

   // the name of the table alias    
   public final static String NAME = "incidentCategory";
     
   // All field names of the table alias "incidentCategory"
   /** 
    * <br>
    * <br>
