 ...
 * 
 * Created on Tue Nov 07 12:36:26 CET 2006
 */
 ...
 * @author andherz
 */
 public class AnonymousIncident extends IFormEventHandler 
 {
	static public final transient String RCS_ID = "$Id: AnonymousIncident.java,v 1.1 2006/11/07 12:04:34 herz Exp $";
  ...
  {
/* dieser Schnippsel wirft eine Exception?!  	
  		context.getDataAccessor().qbeClearAll();
  		IDataBrowser browser = context.getDataBrowser("incidentEntryBrowser");
