 ...
 * 
 * Created on Wed Mar 08 14:45:51 CET 2006
 */
...
/**
 * The event handler for the IncidentOpenIncident generic button.<br>
 * The {@link onAction(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * Insert your custom code within this method.<br>
 * 
 * @author mike
 */
public class IncidentOpenIncident extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: IncidentOpenIncident.java,v 1.1 2006/03/08 15:40:27 mike Exp $";
  ...
  public void onAction(IClientContext context, IGuiElement button) throws Exception
  {
    ...
    String constraint = Incident.state_ENUM._New+"|"+Incident.state_ENUM._Progress;
