 ...
 * 
 * Created on Wed Mar 08 15:54:14 CET 2006
 */
...
/**
 * The event handler for the BudgetButtonUpdateRecord update button.<br>
 * 
 * @author mike
 */
public class BudgetButtonUpdateRecord extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: BudgetButtonUpdateRecord.java,v 1.1 2006/03/08 15:40:27 mike Exp $";
	...
	public void onGroupStatusChanged(IClientContext context, IGuiElement.GroupState status, IGuiElement button) throws Exception
	{
		...
		//
    button.setVisible(context.getUser().hasRole("developer"));
	}
}
