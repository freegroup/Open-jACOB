 ...
 * 
 * Created on Fri Aug 26 15:35:54 CEST 2005
 *
 */
...
import de.tif.jacob.screen.event.IButtonEventHandler;
 ...
 /**
  * The Event handler for the RequestOpenRC-Button.<br>
  ...
  *
  */
public class RequestOpenRC extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: RequestOpenRC.java,v 1.3 2006/02/24 02:16:15 sonntag Exp $";
 	...
 	public void onAction(IClientContext context, IGuiElement button) throws Exception
  {
    ...
    table.qbeSetValue("state","New|Proved|In progress");
    
    // do the search itself
    // 
    browser.search("requestRelationset");
