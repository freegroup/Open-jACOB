 ...
 *
 */
public class RequestRequest_incidentBrowser extends de.tif.jacob.screen.event.IBrowserEventHandler
{
  static public final transient String RCS_ID = "$Id: RequestRequest_incidentBrowser.java,v 1.2 2006/02/24 02:16:15 sonntag Exp $";
