...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:text>Sie sind für Aufgabe </xsl:text><xsl:value-of select="./request/pkey"/><xsl:text disable-output-escaping="yes"> als Tester eingetragen&#10;</xsl:text>
	<h2>Sie wurden als Tester für Aufgabe <xsl:value-of select="./request/pkey"/> eingetragen</h2>
	<hr/>
	<table border="0">
	<tr>
