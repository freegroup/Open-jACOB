...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:text>Aufgabe </xsl:text><xsl:value-of select="./request/pkey"/><xsl:text disable-output-escaping="yes"> wurde auf 'Obsolete' gesetzt&#10;</xsl:text>
	<h2>Die von ihnen erstellte Aufgabe <xsl:value-of select="./request/pkey"/> wurde heute auf den Status 'Obsolete' gesetzt</h2>
	<hr/>
	<table border="0">
	<tr>
