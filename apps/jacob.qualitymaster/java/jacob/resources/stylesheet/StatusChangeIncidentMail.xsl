...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:text>Der Status ihrer Meldung </xsl:text><xsl:value-of select="./incident/pkey"/><xsl:text disable-output-escaping="yes"> hat sich geändert&#10;</xsl:text>
	<h2>Der Status der Meldung <xsl:value-of select="./incident/pkey"/> hat sich geändert</h2>
	<hr/>
