...
function toggleArea(event)
{
  ...
  if(!toggleFx)
  {
     ...
     {
        // HÉ¬ØÇ¬øÇ¬©henangabe im Style muÉ¬ØÇ¬øÇ¬© entfernt werden sonst funktioniert der
...
(function() 
{
  ...
  Event.observe(window, "load", function() 
  {
      ...
      m.remove;
      // die bereits eingefÉ¬ØÇ¬øÇ¬©gten Gruppen mit dem berechneten Wert aktualisieren
      //
      ...
      Event.observe($("add_group"), "click", function()
      {
          ...
          new Ajax.Request("rpc/addGroup.jsp",
          {
            ...
            { 
                ...
                // alle bestehenden gruppen um 1 hochzÉ¬ØÇ¬øÇ¬©hlen
                //
                var children = $("group_parent").select("div.group");
                var groupCount = children.length;
                for(var i=1;i<=groupCount;i++)
      ...
      Event.observe(document, "mousemove", function(event)
      {
         ...
         {
            // alle margin-left der É¬ØÇ¬øÇ¬©bergeordneten gruppen addieren und das was 
