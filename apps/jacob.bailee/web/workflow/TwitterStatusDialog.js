...
function TwitterStatusDialog(/*:Figure*/ figure)
{
  this.figure = figure;
  this.inputDiv = null
  this.inputTo = null;
  ...
  Dialog.call(this);
  this.setDimension(610,320);
  return this;
}
TwitterStatusDialog.prototype = new Dialog;
TwitterStatusDialog.prototype.type="TwitterStatusDialog";


TwitterStatusDialog.prototype.createHTMLElement=function()
{
  ...
  label.innerHTML="Twitter Account:";
  ...
  this.inputPassword.dialog = this;
  this.inputPassword.style.border="1px solid gray";
  this.inputPassword.type="password";
  this.inputPassword.onfocus=function(){this.dialog.currentElement=this;}
  this.inputPassword.style.font="normal 10px verdana";
  this.inputPassword.style.position = "absolute";
  this.inputPassword.style.top="80px";
  this.inputPassword.style.left=this.leftOffset+"px";
  this.inputPassword.style.marginBottom="10px";
  value = this.figure.getProperty("parameter_1");
  if(value)
    this.inputPassword.value = value;
  else
    this.inputPassword.value = "";
  this.inputDiv.appendChild(this.inputPassword);
  ...
  label.style.left = this.leftOffset+"px";
  label.style.position = "absolute";
  label.innerHTML="Twitter Message:";
  this.inputDiv.appendChild(label);
  ...
  this.inputMessage.style.height="150px";
...
TwitterStatusDialog.prototype.setDimension=function( w /*:int*/, h /*:int*/)
{
  ...
  if(this.inputDiv!=null)
  {
    ...
    this.inputPassword.style.width=""+(this.getWidth()-this.leftOffset-20)+"px";
...
TwitterStatusDialog.prototype.onOk=function()
{
  Dialog.prototype.onOk.call(this);
  this.figure.setProperty("parameter_0", this.inputTo.value);
  this.figure.setProperty("parameter_1", this.inputPassword.value);
  this.figure.setProperty("parameter_2", this.inputMessage.value);
}

TwitterStatusDialog.prototype.createList=function()
{
    var oThis = this;
...
TwitterStatusDialog.prototype.insert=function(/*:String */ value)
{
