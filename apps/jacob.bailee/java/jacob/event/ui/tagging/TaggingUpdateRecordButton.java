 ...
 * 
 * Created on Mon Feb 01 11:08:35 CET 2010
 */
package jacob.event.ui.tagging;
...
/**
 * The event handler for the TaggingUpdateRecordButton update button.<br>
 * 
 * @author andherz
 */
public class TaggingUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: TaggingUpdateRecordButton.java,v 1.1 2010/02/08 16:23:38 freegroup Exp $";
