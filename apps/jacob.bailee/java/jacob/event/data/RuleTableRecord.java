 ...
 * 
 * Created on Thu Jan 07 12:13:03 CET 2010
 */
...
{
  static public final transient String RCS_ID = "$Id: RuleTableRecord.java,v 1.1 2010/01/11 08:50:43 freegroup Exp $";
  ...
  public void afterNewAction(IDataTableRecord tableRecord, IDataTransaction transaction) throws Exception
  {
    String template ="<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>\n"+
                    ...
                    "<rule posX=\"150\" posY=\"205\" ruleId=\"start\">\n"+
  ...
  public void afterCommitAction(IDataTableRecord tableRecord) throws Exception
  {
    ...
    else
    {
      ...
      RuleCache.insert(Context.getCurrent(), alias, action,new RuleDocument(tableRecord.getSaveStringValue(Rule.pkey), rule));
    }
  }
}
