 ...
 * 
 * Created on Tue Oct 26 19:24:02 CEST 2010
 */
 ...
 * The WSDL for this class: http://localhost:8080/docPool/services/docPool/NewSOAPAdapter?wsdl
 ...
 * @author andherz
 */
public class NewSOAPAdapter extends SOAPEntryPoint
{
	...
	public static void main(String[] args) 
	{
		try 
		{
			...
			//
			call.setTargetEndpointAddress("http://localhost:8080/docPool/services/docPool/NewSOAPAdapter");
			
			// Enter a valid user/password for the 'docPool' application
			//
