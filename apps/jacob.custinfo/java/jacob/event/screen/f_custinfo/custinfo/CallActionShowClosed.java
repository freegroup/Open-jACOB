 ...
 *
 */
public class CallActionShowClosed implements ICallAction 
{
	private String label;
	public CallActionShowClosed(String newButtonLabel)
	{
	...
	public void performe(IClientContext context, IDataTable callTable,IGuiElement button) throws Exception
	{
		...
		callTable.qbeSetValue("callstatus", "Fertig gemeldet|Dokumentiert|Geschlossen");
