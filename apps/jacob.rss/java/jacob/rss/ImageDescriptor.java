...
public class ImageDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ImageDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _width
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.math.BigDecimal.class, "_width", "width", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
        ...
        { //-- local scope
            ...
            typeValidator.setMaxInclusive(new java.math.BigDecimal("144"));
            typeValidator.setFractionDigits(0);
            fieldValidator.setValidator(typeValidator);
        }
        desc.setValidator(fieldValidator);
        //-- _height
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.math.BigDecimal.class, "_height", "height", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
        ...
        { //-- local scope
            DecimalValidator typeValidator = new DecimalValidator();
            typeValidator.setMinInclusive(new java.math.BigDecimal("0"));
            typeValidator.setMaxInclusive(new java.math.BigDecimal("400"));
            typeValidator.setFractionDigits(0);
            fieldValidator.setValidator(typeValidator);
        }
        desc.setValidator(fieldValidator);
