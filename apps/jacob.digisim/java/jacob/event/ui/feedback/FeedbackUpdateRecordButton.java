 ...
 * 
 * Created on Thu Aug 23 21:46:19 CEST 2007
 */
package jacob.event.ui.feedback;
...
/**
 * The event handler for the FeedbackUpdateRecordButton update button.<br>
 * 
 * @author andherz
 */
public class FeedbackUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: FeedbackUpdateRecordButton.java,v 1.1 2007/08/26 14:08:27 freegroup Exp $";
	...
	public void onGroupStatusChanged(IClientContext context, IGuiElement.GroupState status, IGuiElement button) throws Exception
	{
		...
		//
		button.setEnable(status==IGuiElement.NEW);
	}
}
