 ...
 * 
 * Created on Tue Feb 06 15:33:58 CET 2007
 */
...
/**
 * The event handler for the My_bugSearchUpdateRecordButton update button.<br>
 * 
 * @author andherz
 */
public class My_bugSearchUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: My_bugSearchUpdateRecordButton.java,v 1.1 2007/02/07 07:50:59 freegroup Exp $";
	...
	public void onGroupStatusChanged(IClientContext context, IGuiElement.GroupState status, IGuiElement button) throws Exception
	{
		...
		{
			String state = context.getSelectedRecord().getSaveStringValue(My_bug.state);
			if(state.equals(My_bug.state_ENUM._closed))
