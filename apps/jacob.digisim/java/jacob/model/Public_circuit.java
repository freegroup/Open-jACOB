 ...
 * 
 *
 * Condition: <b>public_circuit.state='public'</b>
 * DB table: <b>circuit</b>
 *
 **/
public final class Public_circuit
{
   private Public_circuit(){}

   // the name of the table alias	 
   public final static String NAME = "public_circuit";
	 
   // All field names of the table alias "public_circuit"
   /** 
    * <br>
    * <br>
