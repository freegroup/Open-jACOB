 ...
 * 
 *
 * Condition: <b>LOCATE(public_part.mandator_id,'{MANDATORID}' )=1 AND public_part.state='released'</b>
 * DB table: <b>part</b>
 *
 **/
public final class Public_part
{
   private Public_part(){}

   // the name of the table alias	 
   public final static String NAME = "public_part";
	 
   // All field names of the table alias "public_part"
   /** 
    * <br>
    * <br>
