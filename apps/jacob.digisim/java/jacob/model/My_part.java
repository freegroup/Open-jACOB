 ...
 * 
 *
 * Condition: <b>my_part.owner_key='{USERID}' and my_part.state='development'</b>
 * DB table: <b>part</b>
 *
 **/
public final class My_part
{
   private My_part(){}

   // the name of the table alias	 
   public final static String NAME = "my_part";
	 
   // All field names of the table alias "my_part"
   /** 
    * <br>
    * <br>
