...
FlowMenu=function(/*:Workflow*/ workflow)
{
  ...
  this.actionFront.setPosition(18,0);
  this.actionBack.setPosition(36,0);
...
FlowMenu.prototype.onSelectionChanged=function(/*:Figure*/ figure)
{
  ...
  if(figure!=null && this.added==false && !(figure instanceof Line))
  {
...
FlowMenu.prototype.onOtherFigureMoved=function(/*:Figure*/ figure)
{
    ...
    this.setPosition(pos.x+figure.getWidth()+12,pos.y-16);
}

/**
 * @type int
 **/
FlowMenu.prototype.getMinHeight=function()
{
  return 10;
}
