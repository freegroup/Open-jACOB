    ...
    if(figure!=null)
    {
      ...
      if(businessClass!=null || decisionClass!=null)
      {
        ...
        if(decisionClass!=null)
        {
          ...
          // Alle möglichen Ausgänge aufführen
          //
...
WorkflowSerializer.prototype.getConditionalExits=function(workflow /*:Workflow*/, figure /*:Node*/)
{
  ...
  else
  {
    ...
    for(var i=0;i<ports.length;i++)
    {
      ...
      if(nextRule==null)
        text = text + '<conditionalExit value="'+port.getProperty("value")+'"/>\n';
      else
        text = text + '<conditionalExit value="'+port.getProperty("value")+'" ruleId="'+nextRule+'"/>\n';
