...
{
  static public final transient String RCS_ID = "$Id: UserFactory.java,v 1.1 2009/05/22 11:30:47 freegroup Exp $";
  ...
  private IUser createInitialAdministrator()
  {
    try
    {
      ...
      try
      {
        ...
        adminRecord.setValue(trans, Person.name, "Administrator");
  ...
  public List findByFullName(String fullNamePart) throws GeneralSecurityException
  {
    ...
    try
    {
      table.qbeSetValue(Person.name, fullNamePart);
      table.search();
