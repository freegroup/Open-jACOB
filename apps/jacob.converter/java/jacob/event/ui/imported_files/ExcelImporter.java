...
import de.freegroup.dbwire.model.IConverterLogger;
...
public final class ExcelImporter implements IConverterLogger
{
  ...
  /**
   * Falls als Transaction "null" übergeben wird ist das read nur im Testmodus.
   * Es wird versucht die Daten zu parsen und in die Datenbank zu schreiben.
   * Es wird jedoch kein Commit durchgeführt.
   * @param context
   * @param data
