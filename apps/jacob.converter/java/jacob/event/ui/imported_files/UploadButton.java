...
public class UploadButton extends IButtonEventHandler 
{
	...
	public void onClick(IClientContext context, IGuiElement emitter) throws Exception
	{
	    IUploadDialog dialog = context.createUploadDialog(new IUploadDialogCallback()
	    {
	      ...
	      {
	        IDataTableRecord record = Imported_files.newRecord(context);
	        record.setDocumentValue(record.getCurrentTransaction(), Imported_files.excel, DataDocumentValue.create(fileName, fileData));
	        record.setValue(record.getCurrentTransaction(), Imported_files.state, Imported_files.state_ENUM._uploaded);
