...
import de.shorti.baseknowledge.objects.Company;



public class CompanyNameCatalog
{
	...
	*/
	static
	{
		trace.debug2("loading CompanyNameCatalog from database...");
		ArrayList   objects    = Company.getAll();
