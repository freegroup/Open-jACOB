...
{
    static public final transient String RCS_ID = "$Id: UserFactory.java,v 1.2 2009/11/23 11:33:43 R.Spoor Exp $";
    ...
    private IUser createInitialAdministrator()
    {
        try
        {
            ...
            try
            {
                ...
                adminRecord.setValue(trans, Person.has_administration, Boolean.TRUE);
                adminRecord.setValue(trans, Person.has_configuration, Boolean.TRUE);
                adminRecord.setValue(trans, Person.has_debugging, Boolean.TRUE);
                trans.commit();
