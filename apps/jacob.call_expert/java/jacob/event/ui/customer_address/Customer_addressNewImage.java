 ...
 * 
 * Created on Mon Oct 05 15:39:57 CEST 2009
 */
 ...
 * @author achim
 */
public class Customer_addressNewImage extends IStaticImageEventHandler implements IOnClickEventHandler
{
  public void onClick(IClientContext context, IGuiElement element) throws Exception
  {
    MasterDetailManager.onNewClicked(MasterDetailManager_CustomerAddress.INSTANCE, context);
  }
