 ...
 *
 * Created on Mon Oct 05 15:00:15 CEST 2009
 */
 ...
 * @author achim
 */
public class Company_bank_accountUpdateImage extends IStaticImageEventHandler implements IOnClickEventHandler
{

  public void onClick(IClientContext context, IGuiElement element) throws Exception
  {
    MasterDetailManager.onUpdateClicked(MasterDetailManager_CompanyBankAccount.INSTANCE, context);
