 ...
 * 
 * Created on Tue Feb 10 13:48:01 CET 2009
 */
 ...
 * @author achim
 */
public class CompanyContactTopImage extends IStaticImageEventHandler implements IOnClickEventHandler
{
  public void onClick(IClientContext context, IGuiElement element) throws Exception
  {
    ...
    MasterDetailManager.onTopClicked(MasterDetailManager_CompanyContact.INSTANCE, context);
    if (custRecord != null)
