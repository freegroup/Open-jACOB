 ...
 *
 * Created on Wed Feb 18 13:13:56 CET 2009
 */
 ...
 * @author achim
 */
public class CompanyAddressDownImage extends IStaticImageEventHandler implements IOnClickEventHandler
{
    public void onClick(IClientContext context, IGuiElement element) throws Exception
    {
        MasterDetailManager.onDownClicked(MasterDetailManager_CompanyAddress.INSTANCE, context);
    }
}
