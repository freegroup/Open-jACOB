 ...
 * 
 * Created on Tue Feb 10 13:49:22 CET 2009
 */
 ...
 * @author achim
 */
public class CompanyContactUpImage extends IStaticImageEventHandler implements IOnClickEventHandler
{
  public void onClick(IClientContext context, IGuiElement element) throws Exception
  {
    ...
    MasterDetailManager.onUpClicked(MasterDetailManager_CompanyContact.INSTANCE, context);
    if (custRecord != null)
