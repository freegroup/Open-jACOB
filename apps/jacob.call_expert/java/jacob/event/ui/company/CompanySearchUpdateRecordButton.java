 ...
 * 
 * Created on Mon Jan 19 15:36:15 CET 2009
 */
...
/**
 * The event handler for the CompanySearchUpdateRecordButton update button.<br>
 * 
 * @author andherz
 */
public class CompanySearchUpdateRecordButton extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: CompanySearchUpdateRecordButton.java,v 1.1 2009/02/17 15:12:19 A.Boeken Exp $";
  ...
  try
  {
    System.out.println(context.getSelectedRecord());
  }
  catch(Exception e)
  {
    
  }
  super.onError(context, button, reason);
  }
