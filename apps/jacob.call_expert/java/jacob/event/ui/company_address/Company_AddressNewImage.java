 ...
 *
 * Created on Fri Oct 02 18:43:21 CEST 2009
 */
 ...
 * @author achim
 */
public class Company_AddressNewImage extends IStaticImageEventHandler  implements IOnClickEventHandler
{
    /**
    ...
    {
        MasterDetailManager.onNewClicked(MasterDetailManager_CompanyAddress.INSTANCE, context);
    }
}
