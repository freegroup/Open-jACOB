...
{
    static public final transient String RCS_ID = "$Id: Email.java,v 1.4 2009/11/23 11:33:44 R.Spoor Exp $";
        ...
        if(table.recordCount()!=1)
        {
            ...
            if(table.recordCount()==0)
            {
                ...
                try
                {
                    ...
                    configuration.setStringValue(trans, jacob.model.Email.smtp_server, "<your SMPT server here>");
                    trans.commit();
                }
                finally
                {
