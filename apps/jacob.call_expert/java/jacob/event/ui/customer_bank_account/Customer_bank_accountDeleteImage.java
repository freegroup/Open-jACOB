 ...
 * 
 * Created on Mon Oct 05 15:37:17 CEST 2009
 */
 ...
 * @author achim
 */
public class Customer_bank_accountDeleteImage extends IStaticImageEventHandler implements IOnClickEventHandler
{
  public void onClick(IClientContext context, IGuiElement element) throws Exception
  {
    MasterDetailManager.onDeleteClicked(MasterDetailManager_CustomerBankAccount.INSTANCE, context);
  }
}
