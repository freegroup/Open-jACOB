 ...
 *
 * Created on Wed Jul 01 12:36:35 CEST 2009
 */
...
/**
 * The event handler for the FollowupShowCallButton generic button.<br>
 * The {@link onAction(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * Insert your custom code within this method.<br>
 *
 * @author andherz
 */
public class FollowupShowCallButton extends IButtonEventHandler
{
    static public final transient String RCS_ID = "$Id: FollowupShowCallButton.java,v 1.2 2009/11/23 11:33:44 R.Spoor Exp $";
