 ...
 *
 * Created on Fri Oct 02 17:15:54 CEST 2009
 */
...
/**
 * The event handler for the CustomerUpdateRecordButtonTabPane update button.<br>
 *
 * @author achim
 */
public class CustomerUpdateRecordButtonTabPane extends IActionButtonEventHandler
{
    static public final transient String RCS_ID = "$Id: CustomerUpdateRecordButtonTabPane.java,v 1.2 2009/11/23 11:33:42 R.Spoor Exp $";
    ...
    public void onSuccess(IClientContext context, IGuiElement button) throws Exception
    {
        ...
        if (customerRec != null && customerRec.isUpdated())
        {

            IDataTransaction transaction = customerRec.getCurrentTransaction();
            IDataTableRecord eventRecord = context.getDataTable(Event_edit_customer.NAME).newRecord(transaction);
            eventRecord.setValue(transaction, Event_edit_customer.type, Event_edit_customer.type_ENUM._ChangeCustomer);
        }
    }
