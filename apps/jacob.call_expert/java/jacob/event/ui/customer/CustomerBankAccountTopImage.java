 ...
 * 
 * Created on Mon Feb 09 15:47:54 CET 2009
 */
 ...
 * @author achim
 */
public class CustomerBankAccountTopImage extends IStaticImageEventHandler implements IOnClickEventHandler
{
  public void onClick(IClientContext context, IGuiElement element) throws Exception
  {
    MasterDetailManager.onTopClicked(MasterDetailManager_CustomerBankAccount.INSTANCE, context);
  }
}
