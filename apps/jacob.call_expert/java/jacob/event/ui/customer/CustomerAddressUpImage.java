 ...
 * 
 * Created on Thu Feb 05 14:46:55 CET 2009
 */
 ...
 * @author achim
 */
public class CustomerAddressUpImage extends IStaticImageEventHandler implements IOnClickEventHandler
{
  public void onClick(IClientContext context, IGuiElement element) throws Exception
  {
    MasterDetailManager.onUpClicked(MasterDetailManager_CustomerAddress.INSTANCE, context);
  }
}
