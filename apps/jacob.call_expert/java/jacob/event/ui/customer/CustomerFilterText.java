 ...
 * 
 * Created on Wed Nov 05 09:15:55 CET 2008
 */
 ...
 * @author achim
 */
 public class CustomerFilterText extends ITextFieldEventHandler // implements IAutosuggestProvider, HotkeyEventHandler
 {
	static public final transient String RCS_ID = "$Id: CustomerFilterText.java,v 1.1 2009/02/17 15:12:13 A.Boeken Exp $";
   ...
   * @param status The new group status
    ...
    //
    text.setEnable(!(state==IGroup.NEW || state==IGroup.UPDATE));
	}
