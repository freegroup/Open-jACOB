 ...
 * 
 * Created on Wed Jun 10 15:24:21 CEST 2009
 */
 ...
 * @author achim
 */
public class Storage_email_outboundStaticImage_BulletList extends IStaticImageEventHandler implements IOnClickEventHandler
{
  public void onClick(IClientContext context, IGuiElement element) throws Exception
  {
    HTMLEditorHelper.insertListTag(context,false);
  }
