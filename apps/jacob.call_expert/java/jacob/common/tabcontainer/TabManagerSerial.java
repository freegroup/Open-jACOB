...
public class TabManagerSerial
{
    private static String CONTAINER_NAME = "requestSerialContainer";
    ...
    public static void showNewTab(IClientContext context) throws Exception
    {
        ...
        context.getGroup().findByName("requestProduct").setEnable(false);
        context.getGroup().findByName("requestModel").setEnable(false);
    }
    ...
    public static void showDisplayTab(IClientContext context) throws Exception
    {
        ...
        context.getGroup().findByName("requestProduct").setEnable(true);
        context.getGroup().findByName("requestModel").setEnable(true);
    }
