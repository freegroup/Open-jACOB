 ...
 * 
 * Created on Mon Jan 09 11:28:57 CET 2006
 */
...
/**
 * The event handler for the TaskSetQA record selected button.<br>
...
{
  static public final transient String RCS_ID = "$Id: TaskSetQA.java,v 1.2 2006/11/10 07:51:52 achim Exp $";
  ...
  public void onAction(IClientContext context, IGuiElement button) throws Exception
  {
    ...
    try
    {
      currentRecord.setValue(currentTransaction, Task.taskstatus, Task.taskstatus_ENUM._QA);
  ...
  public void onGroupStatusChanged(IClientContext context, IGuiElement.GroupState status, IGuiElement button) throws Exception
  {
    ...
    button.setEnable(Task.taskstatus_ENUM._Owned.equals(taskstatus));
  }
}
