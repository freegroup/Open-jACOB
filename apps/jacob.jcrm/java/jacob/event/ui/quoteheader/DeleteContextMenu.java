 ...
 * 
 * Created on Wed Oct 12 00:18:20 CEST 2005
 *
 */
 ...
 *
 */
public class DeleteContextMenu extends IActionButtonEventHandler 
{
  static public final transient String RCS_ID = "$Id: DeleteContextMenu.java,v 1.1 2005/10/12 15:29:01 sonntag Exp $";
  ...
  {
	  // only quotes in open status could be deleted
    emitter.setEnable(status == IGuiElement.SELECTED && "Open".equals(context.getSelectedRecord().getSaveStringValue("status")));
  }
}
