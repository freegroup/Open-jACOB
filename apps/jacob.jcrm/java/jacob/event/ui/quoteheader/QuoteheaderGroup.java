 ...
 * 
 * Created on Thu Oct 13 14:52:15 CEST 2005
 */
 ...
 * @author andreas
 */
 public class QuoteheaderGroup extends IGroupListenerEventHandler 
 {
	static public final transient String RCS_ID = "$Id: QuoteheaderGroup.java,v 1.1 2005/10/13 23:54:44 sonntag Exp $";
	...
	public void onGroupStatusChanged(IClientContext context, GroupState status, IGuiElement emitter) throws Exception
	{
	  // new button of lineitem group should only be enabled, if this group is in the selected mode
		context.getForm().findByName("quotelineitemButtonNewRecord").setEnable(status == IGuiElement.SELECTED);
	}
}
