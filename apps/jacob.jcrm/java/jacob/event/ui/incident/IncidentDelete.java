 ...
 * 
 * Created on Mon Mar 06 13:28:30 CET 2006
 */
 ...
 *
 */
public class IncidentDelete extends IActionButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: IncidentDelete.java,v 1.2 2006/11/10 07:51:58 achim Exp $";
    ...
    {
      String recordStatus = context.getSelectedRecord().getSaveStringValue(Incident.status);
      button.setEnable(Incident.status_ENUM._Assigned.equals(recordStatus)||Incident.status_ENUM._New.equals(recordStatus)) ;
    }
	}
}
