...
public final class SalesprojectOrganization
{
   private SalesprojectOrganization(){}

   // the name of the table alias	 
   public final static String NAME = "salesprojectOrganization";
	 
   // All field names of the table alias "salesprojectOrganization"
   /** 
     required: true<br>
     type:     LONG<br>
   */
