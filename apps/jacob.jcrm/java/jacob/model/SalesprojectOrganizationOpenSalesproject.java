...
public final class SalesprojectOrganizationOpenSalesproject
{
   private SalesprojectOrganizationOpenSalesproject(){}

   // the name of the table alias	 
   public final static String NAME = "salesprojectOrganizationOpenSalesproject";
	 
   // All field names of the table alias "salesprojectOrganizationOpenSalesproject"
   /** 
     required: true<br>
     type:     LONG<br>
   */
