...
public final class SalesprojectAgent
{
   private SalesprojectAgent(){}

   // the name of the table alias	 
   public final static String NAME = "salesprojectAgent";
	 
   // All field names of the table alias "salesprojectAgent"
   /** 
     required: true<br>
     type:     LONG<br>
   */
