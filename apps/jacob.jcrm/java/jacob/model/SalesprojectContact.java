...
public final class SalesprojectContact
{
   private SalesprojectContact(){}

   // the name of the table alias	 
   public final static String NAME = "salesprojectContact";
	 
   // All field names of the table alias "salesprojectContact"
   /** 
     required: true<br>
     type:     LONG<br>
   */
