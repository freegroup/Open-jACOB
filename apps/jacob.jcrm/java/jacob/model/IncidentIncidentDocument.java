...
public final class IncidentIncidentDocument
{
   private IncidentIncidentDocument(){}

   // the name of the table alias	 
   public final static String NAME = "incidentIncidentDocument";
	 
   // All field names of the table alias "incidentIncidentDocument"
   /** 
     required: true<br>
     type:     LONG<br>
   */
