...
public final class ActivityWorkgroup
{
   private ActivityWorkgroup(){}

   // the name of the table alias	 
   public final static String NAME = "activityWorkgroup";
	 
   // All field names of the table alias "activityWorkgroup"
   /** 
     required: true<br>
     type:     LONG<br>
   */
