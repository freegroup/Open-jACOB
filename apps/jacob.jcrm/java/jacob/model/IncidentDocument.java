...
public final class IncidentDocument
{
   private IncidentDocument(){}

   // the name of the table alias	 
   public final static String NAME = "incidentDocument";
	 
   // All field names of the table alias "incidentDocument"
   /** 
     required: true<br>
     type:     LONG<br>
   */
