...
public final class MailinstoreAgent
{
   private MailinstoreAgent(){}

   // the name of the table alias	 
   public final static String NAME = "mailinstoreAgent";
	 
   // All field names of the table alias "mailinstoreAgent"
   /** 
     required: true<br>
     type:     LONG<br>
   */
