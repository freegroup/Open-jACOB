...
public final class OrderContactOrganization
{
   private OrderContactOrganization(){}

   // the name of the table alias	 
   public final static String NAME = "orderContactOrganization";
	 
   // All field names of the table alias "orderContactOrganization"
   /** 
     required: true<br>
     type:     LONG<br>
   */
