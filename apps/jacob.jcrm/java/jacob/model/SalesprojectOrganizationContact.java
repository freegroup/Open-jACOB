...
public final class SalesprojectOrganizationContact
{
   private SalesprojectOrganizationContact(){}

   // the name of the table alias	 
   public final static String NAME = "salesprojectOrganizationContact";
	 
   // All field names of the table alias "salesprojectOrganizationContact"
   /** 
     required: true<br>
     type:     LONG<br>
   */
