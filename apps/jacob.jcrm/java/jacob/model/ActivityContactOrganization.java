...
public final class ActivityContactOrganization
{
   private ActivityContactOrganization(){}

   // the name of the table alias	 
   public final static String NAME = "activityContactOrganization";
	 
   // All field names of the table alias "activityContactOrganization"
   /** 
     required: true<br>
     type:     LONG<br>
   */
