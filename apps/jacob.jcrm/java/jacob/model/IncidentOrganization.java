...
public final class IncidentOrganization
{
   private IncidentOrganization(){}

   // the name of the table alias	 
   public final static String NAME = "incidentOrganization";
	 
   // All field names of the table alias "incidentOrganization"
   /** 
     required: true<br>
     type:     LONG<br>
   */
