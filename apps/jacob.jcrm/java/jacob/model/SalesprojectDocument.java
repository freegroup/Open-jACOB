...
public final class SalesprojectDocument
{
   private SalesprojectDocument(){}

   // the name of the table alias	 
   public final static String NAME = "salesprojectDocument";
	 
   // All field names of the table alias "salesprojectDocument"
   /** 
     required: true<br>
     type:     LONG<br>
   */
