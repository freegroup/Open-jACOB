...
public final class ContractFinancialContact
{
   private ContractFinancialContact(){}

   // the name of the table alias	 
   public final static String NAME = "contractFinancialContact";
	 
   // All field names of the table alias "contractFinancialContact"
   /** 
     required: true<br>
     type:     LONG<br>
   */
