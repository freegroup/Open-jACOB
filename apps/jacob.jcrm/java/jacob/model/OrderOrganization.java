...
public final class OrderOrganization
{
   private OrderOrganization(){}

   // the name of the table alias	 
   public final static String NAME = "orderOrganization";
	 
   // All field names of the table alias "orderOrganization"
   /** 
     required: true<br>
     type:     LONG<br>
   */
