...
public final class OrderOrderpart
{
   private OrderOrderpart(){}

   // the name of the table alias	 
   public final static String NAME = "orderOrderpart";
	 
   // All field names of the table alias "orderOrderpart"
   /** 
     required: true<br>
     type:     LONG<br>
   */
