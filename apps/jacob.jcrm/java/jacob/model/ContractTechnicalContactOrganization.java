...
public final class ContractTechnicalContactOrganization
{
   private ContractTechnicalContactOrganization(){}

   // the name of the table alias	 
   public final static String NAME = "contractTechnicalContactOrganization";
	 
   // All field names of the table alias "contractTechnicalContactOrganization"
   /** 
     required: true<br>
     type:     LONG<br>
   */
