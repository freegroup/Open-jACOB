...
public final class ContractContractDocument
{
   private ContractContractDocument(){}

   // the name of the table alias	 
   public final static String NAME = "contractContractDocument";
	 
   // All field names of the table alias "contractContractDocument"
   /** 
     required: true<br>
     type:     LONG<br>
   */
