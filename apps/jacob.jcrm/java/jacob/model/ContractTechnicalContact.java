...
public final class ContractTechnicalContact
{
   private ContractTechnicalContact(){}

   // the name of the table alias	 
   public final static String NAME = "contractTechnicalContact";
	 
   // All field names of the table alias "contractTechnicalContact"
   /** 
     required: true<br>
     type:     LONG<br>
   */
