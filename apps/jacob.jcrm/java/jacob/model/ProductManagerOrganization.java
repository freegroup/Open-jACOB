...
public final class ProductManagerOrganization
{
   private ProductManagerOrganization(){}

   // the name of the table alias	 
   public final static String NAME = "productManagerOrganization";
	 
   // All field names of the table alias "productManagerOrganization"
   /** 
     required: true<br>
     type:     LONG<br>
   */
