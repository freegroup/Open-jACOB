...
public final class ContractFinancialContactOrganization
{
   private ContractFinancialContactOrganization(){}

   // the name of the table alias	 
   public final static String NAME = "contractFinancialContactOrganization";
	 
   // All field names of the table alias "contractFinancialContactOrganization"
   /** 
     required: true<br>
     type:     LONG<br>
   */
