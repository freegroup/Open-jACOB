...
public final class QuoteContactOrganization
{
   private QuoteContactOrganization(){}

   // the name of the table alias	 
   public final static String NAME = "quoteContactOrganization";
	 
   // All field names of the table alias "quoteContactOrganization"
   /** 
     required: true<br>
     type:     LONG<br>
   */
