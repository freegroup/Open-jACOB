...
public final class IncidentContact
{
   private IncidentContact(){}

   // the name of the table alias	 
   public final static String NAME = "incidentContact";
	 
   // All field names of the table alias "incidentContact"
   /** 
     required: true<br>
     type:     LONG<br>
   */
