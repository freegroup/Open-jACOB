...
public final class OrderOrderDocument
{
   private OrderOrderDocument(){}

   // the name of the table alias	 
   public final static String NAME = "orderOrderDocument";
	 
   // All field names of the table alias "orderOrderDocument"
   /** 
     required: true<br>
     type:     LONG<br>
   */
