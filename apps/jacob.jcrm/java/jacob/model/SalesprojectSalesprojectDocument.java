...
public final class SalesprojectSalesprojectDocument
{
   private SalesprojectSalesprojectDocument(){}

   // the name of the table alias	 
   public final static String NAME = "salesprojectSalesprojectDocument";
	 
   // All field names of the table alias "salesprojectSalesprojectDocument"
   /** 
     required: true<br>
     type:     LONG<br>
   */
