 ...
 *
 */
public abstract class AbstractRecordDelete extends IButtonEventHandler
{
  ...
  public void onGroupStatusChanged(IClientContext context, GroupState status, IGuiElement emitter) throws Exception
  {
    ...
    emitter.setEnable(!"to delete".equals(context.getSelectedRecord().getValue(getFieldvalue())));
  }
  ...
  public void onAction(IClientContext context, IGuiElement button) throws Exception
  {
    ...
    try
    {
      context.getSelectedRecord().setValue(currentTransaction, getFieldvalue(), "to delete");
