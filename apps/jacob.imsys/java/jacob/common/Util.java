...
public class Util
{
  static public final transient String RCS_ID = "$Id: Util.java,v 1.4 2006/03/02 15:30:49 mike Exp $";
  static public final transient String RCS_REV = "$Revision: 1.4 $";
	 ...
	 * @throws Exception
	 */
	public static boolean isSystemUser(Context context) throws Exception
	{
        {
            // MIKE: HACK HACK. Bitte ordentliche API bereitstellen um SystemUser zu erkennen
            //
            try
            {
	...
	public static String getUserKey(Context context) throws Exception
	{
		...
		{
			userKey=DataUtils.getAppprofileValue(context,"agent_key");
		}
		else
		{
