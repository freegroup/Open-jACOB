 ...
 * 
 * Created on Tue Jun 14 11:26:40 CEST 2005
 *
 */
...
import de.tif.jacob.screen.event.IButtonEventHandler;
 ...
 /**
  * The Event handler for the TaskSetInProcess-Button.<br>
  ...
  *
  */
public class TaskSetInProcess extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: TaskSetInProcess.java,v 1.1 2005/06/14 09:53:50 mike Exp $";
  ...
  static private final transient Log logger = AppLogger.getLogger();
    ...
    public static class TaskSetResolvedCallback implements IOkCancelDialogCallback
    {
        ...
        {
            Task.setStatus(null,context,context.getSelectedRecord(), "In Arbeit");
    ...
    public void onAction(IClientContext context, IGuiElement button)
            throws Exception 
    {
        IOkCancelDialog dialog = context.createOkCancelDialog("Wollen Sie den Auftrag wirklich 'In Arbeit' melden?",new TaskSetResolvedCallback());
        dialog.show();
    ...
    
    {
            if(status == IGuiElement.SELECTED)
            {
                ...
                button.setEnable(taskstatus.equals("Freigegeben")); 
            }
    }
