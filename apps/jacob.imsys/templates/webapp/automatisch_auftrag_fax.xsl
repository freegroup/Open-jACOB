	...
	<xsl:template match="/doc/data">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="simple" initial-page-number="1">
				...
				-->
				<fo:static-content background-color="white" flow-name="xsl-region-after">
...
-->
					...
					<fo:table table-layout="fixed" space-before.optimum="30pt">
						<fo:table-column column-width="16cm"/>
							<fo:table-body font-size="12pt" font-family="courier">
							<!-- HEADER  -->
							<fo:table-row font-size="16pt" line-height="20pt">
								<fo:table-cell>
...
-->
					<!--
					      Hier beginnt der 1. Textblock mit dem IM-FAX-KOPF
					-->
					<fo:table table-layout="fixed" space-before.optimum="30pt">
