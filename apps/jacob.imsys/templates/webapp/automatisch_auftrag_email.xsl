...
<xsl:template match="/">
					...
					<xsl:text> </xsl:text>
					<xsl:value-of select="./doc/data/taskworkgroup/name" />
					<xsl:text>&#13;&#10;</xsl:text>
					...
					<xsl:text>&#13;&#10;</xsl:text>
					<xsl:text>Ansprechpartner: </xsl:text><xsl:value-of select="./doc/data/general/Ansprechpartner" /><xsl:text>&#13;&#10;</xsl:text>
					<xsl:text>&#13;&#10;</xsl:text>
					<xsl:text>&#13;&#10;</xsl:text>					
					...
					<xsl:text>&#13;&#10;</xsl:text>
					<xsl:text>&#13;&#10;</xsl:text>
					<xsl:text>*** Beginn: </xsl:text><xsl:value-of select="./doc/data/task/estimatedstart" /><xsl:text>&#13;&#10;</xsl:text>
					<xsl:text>***</xsl:text><xsl:text>&#13;&#10;</xsl:text>
					<xsl:text>*** Ende  : </xsl:text><xsl:value-of select="./doc/data/task/estimateddone" /><xsl:text>&#13;&#10;</xsl:text>
					<xsl:text>&#13;&#10;</xsl:text>
					<xsl:text>&#13;&#10;</xsl:text>
                    ...
                    <xsl:text>***    Tel   : 0711/17-161 intern: -161 (07 Uhr - 18 Uhr)              ***</xsl:text><xsl:text>&#13;&#10;</xsl:text>
                    <xsl:text>***    FAX   : 0711/17-53133                                           ***</xsl:text><xsl:text>&#13;&#10;</xsl:text>
                    <xsl:text>***    E-Mail: Pool-ID.161@DaimlerChrysler.Com                         ***</xsl:text><xsl:text>&#13;&#10;</xsl:text>
                    <xsl:text>**************************************************************************</xsl:text>
                    <xsl:text>&#13;&#10;</xsl:text>
                </xsl:template>
</xsl:stylesheet>
