 		...
 		<!--
 					...
 					-->
 				        <fo:table table-layout="fixed" space-before.optimum="30pt">
 				            ...
 				            <fo:table-column column-width="33cm"/>
 				            <fo:table-body font-size="10pt" font-family="sans-serif">
 				                  ...
 				                  <!-- 1 Zeile  -->
                                     ...
                                     <fo:table-row line-height="12pt">
 					                  ...
 					                  <fo:table-cell >
 					                     <fo:block text-align="start" ><xsl:text>Fertigmeldung: </xsl:text><xsl:value-of select="./call/pkey" />
 							     <xsl:text> vom: </xsl:text><xsl:value-of select="./call/datereported" />
 				    ...
 				    <fo:table-row line-height="12pt" >
 			            ...
 			            <fo:table-row line-height="12pt" >
 					                  ...
 					                  <fo:table-cell>
 								<fo:block text-align="start" ><xsl:text>FWT hat Ihren Auftrag mit der oben genannten ID-Nummer erledigt und fertig gemeldet.</xsl:text></fo:block>
 					                  </fo:table-cell>
                                     </fo:table-row>
 			            <fo:table-row line-height="12pt" >
 					                  <fo:table-cell>
