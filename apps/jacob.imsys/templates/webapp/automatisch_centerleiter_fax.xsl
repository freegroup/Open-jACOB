			...
			<fo:page-sequence master-reference="simple" initial-page-number="1">
				...
				<fo:table   table-layout="fixed">
				      <fo:table-column column-width="6cm"/>
					   ...
					   <fo:table-cell>
					      <fo:block ><fo:external-graphic height="20mm" src="url('http://53.186.5.110/yan/DaimlerChrysler.gif')"/></fo:block>
					   </fo:table-cell>
					   <fo:table-cell>
				        ...
				        <fo:table   table-layout="fixed" space-before.optimum="10pt">
				            ...
				            <fo:table-body font-size="10pt" font-family="sans-serif">
                              ...
                              <fo:table-row line-height="13pt">
					                  ...
					                  <fo:table-cell>
					                     <fo:block text-align="start" ><xsl:text>Produktionsbereich</xsl:text></fo:block>
					                  </fo:table-cell>
					                  <fo:table-cell>
					                     <fo:block  text-align="start" ><xsl:value-of select="./general/production_area" /></fo:block>
					                  </fo:table-cell>
                              </fo:table-row>
				        ...
				        <fo:table  table-layout="fixed" space-before.optimum="10pt">
				            ...
				            <fo:table-body font-size="10pt" font-family="sans-serif">
                              ...
                              <fo:table-row line-height="25pt"   >
					                  ...
					                  <fo:table-cell>
					                     <fo:block  text-align="start" ><xsl:value-of select="./general/production_lost" /></fo:block>
					                  </fo:table-cell>
                              </fo:table-row>
				                  <!-- Störmeldeeingang  -->
                              ...
                              <fo:table-row line-height="13pt">
					                  ...
					                  <fo:table-cell>
					                     <fo:block  text-align="start" ><xsl:value-of select="./general/trouble_start" /></fo:block>
					                  </fo:table-cell>
                              </fo:table-row>
                              ...
                              <fo:table-row line-height="13pt">
					                  ...
					                  <fo:table-cell>
					                     <fo:block  text-align="start" ><xsl:value-of select="./general/produktion_lost_duration" /></fo:block>
					                  </fo:table-cell>
                              </fo:table-row>
                                    </fo:table-body>
				        </fo:table>
				        ...
				        <fo:table  table-layout="fixed" space-before.optimum="10pt">
				            ...
				            <fo:table-body font-size="10pt" font-family="sans-serif">
                              ...
                              <fo:table-row line-height="13pt">
					                  ...
					                  <fo:table-cell>
					                     <fo:block  text-align="start" ><xsl:value-of select="./general/trouble_reason" /></fo:block>
					                  </fo:table-cell>
                              </fo:table-row>
