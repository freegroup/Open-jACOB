...
BEGIN
   ...
   if (timedocdiff<>0 or timespentdiff<>0 or opentaskcntdiff<>0 or closedtaskcntdiff<>0 or amountdiff<>0) then
      UPDATE calls SET 
         ...
         sumtaskamount=sumtaskamount+amountdiff,
         sumtasktimespent=sumtasktimespent+timespentdiff,
         sumtaskdoc=sumtaskdoc+timedocdiff,
         totalcalltime=totalcalltime+timedocdiff+timespentdiff
      ...
      UPDATE calls SET 
         ...
         sumtaskdoc=sumtaskdoc+timedocdiff,
         totalcalltime=totalcalltime+timedocdiff+timespentdiff
      WHERE pkey=(Select mastercall_key from calls where pkey= :new.calltask);
