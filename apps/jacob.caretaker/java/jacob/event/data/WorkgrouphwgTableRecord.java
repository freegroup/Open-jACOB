...
public class WorkgrouphwgTableRecord extends DataTableRecordEventHandler
{
	...
	public void beforeCommitAction(IDataTableRecord tableRecord, IDataTransaction transaction) throws Exception
	{
      ...
      String message="HWG " + tableRecord.getSaveStringValue("hwg_key") + " wurde geändert";
      if (tableRecord.isNew())
      {
        message = "HWG " + tableRecord.getSaveStringValue("hwg_key") + " wurde zugefügt";
      }
      else if (tableRecord.isDeleted())
      {
        message = "HWG " + tableRecord.getSaveStringValue("hwg_key") + " wurde gelöscht";
      }
      workgroupRecord.appendToHistory(transaction, message);
		}
	}
