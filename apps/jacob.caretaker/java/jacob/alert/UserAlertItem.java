...
{
  static public final transient String RCS_ID = "$Id: UserAlertItem.java,v 1.7 2005/03/03 15:38:15 sonntag Exp $";
   ...
   * 
   */
  public UserAlertItem(IDataTableRecord alert) throws Exception
  {
