 ...
 *
 */
public class AllAlertItem extends IAlertItem
{
  static public final transient String RCS_ID = "$Id: AllAlertItem.java,v 1.6 2005/02/16 10:07:29 mike Exp $";
   ...
   * 
   */
  public AllAlertItem(IDataTableRecord alert) throws Exception
  {
