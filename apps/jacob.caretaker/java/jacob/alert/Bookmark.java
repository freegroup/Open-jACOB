...
{
  static public final transient String RCS_ID = "$Id: Bookmark.java,v 1.8 2005/03/03 15:38:15 sonntag Exp $";
  ...
  public Bookmark(IDataTableRecord alert) throws Exception
  {
    ...
    this.callPkey= alert.getStringValue("tablekey");
