 ...
 * 
 */
public class AskAttachmentTaskSearch extends IButtonEventHandler
{
  /**
  ...
  public static class CallPkeyAskCallback implements IAskDialogCallback
  {
    ...
    public void onOk(IClientContext context, String pkey)
    {
      try
      {
        AskAttachmentTaskSearch.searchAndDisplayResult(context, pkey);
      }
      catch (Exception e)
      {
        e.printStackTrace();
  ...
  {
    IDataTable taskTable = context.getDataTable("task"); // any function
                                                          // related
    // table
  ...
  protected static void searchAndDisplayResult(IClientContext context, String taskPkey) throws Exception
  {
    ...
    // 
    browser.search("r_attachment", Filldirection.BOTH);
