 ...
 * 
 * Created on Tue Dec 18 10:18:39 CET 2007
 */
package jacob.common.gui.hwgtasktype;
 ...
 * The {@link onAction(IClientCont IGuiElement)} will be called, if the user
...
{
  static public final transient String RCS_ID = "$Id: DeleteBrowser.java,v 1.1 2007/12/18 14:17:19 achim Exp $";
  ...
  {
    IOkCancelDialog dialog = context.createOkCancelDialog("Datensätze im Browser werden gelöscht! \\r\\nLöschen?", new IOkCancelDialogCallback()
    {

      public void onOk(IClientContext context) throws Exception
      {
        IDataBrowser exBrowser = context.getDataBrowser("hwgtasktypeBrowser");
