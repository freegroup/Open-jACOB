 ...
 * 
 * Created on Tue Apr 29 11:01:25 CEST 2008
 */
package jacob.common.gui.customerint;
...
/**
 * The event handler for the SetUserAsCustomer search button.<br>
 * 
 * @author achim
 */
public class SetUserAsCustomer extends ISearchActionEventHandler
{
  static public final transient String RCS_ID = "$Id: SetUserAsCustomer.java,v 1.1 2008/04/29 12:53:36 achim Exp $";
  ...
  {
    IDataTable cust = context.getDataTable();
    context.clearDomain();
    cust.qbeClear();
    cust.qbeSetKeyValue("pkey", context.getUser().getKey());
    return true;
  ...
  public void onGroupStatusChanged(IClientContext context, IGuiElement.GroupState status, IGuiElement button) throws Exception
  {
    ...
    button.setLabel("Benutzer setzen");
  }
}
