 ...
 * 
 * Created on Tue Sep 04 10:32:50 CEST 2007
 */
...
/**
 * The event handler for the DeleteBrowserRec generic button.<br>
 ...
 * @author achim
 */
public class DeleteBrowserRec extends IButtonEventHandler
{
  static public final transient String RCS_ID = "$Id: DeleteBrowserRec.java,v 1.2 2007/12/18 14:17:19 achim Exp $";
  ...
  {
    IOkCancelDialog dialog = context.createOkCancelDialog("Alle Synchronisationsanweisungen im Browser werden gelöscht!\nLöschen?", new MyCallback());
    dialog.show();
  }
