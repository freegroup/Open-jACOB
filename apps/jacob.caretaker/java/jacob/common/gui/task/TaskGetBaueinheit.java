 ...
 *
 */
public  class TaskGetBaueinheit extends IButtonEventHandler
{
  static public final transient String RCS_ID = "$Id: TaskGetBaueinheit.java,v 1.3 2004/11/16 18:36:35 mike Exp $";
  ...
  /* 
    ...
    {   
      ...
      // retrieve the element where you want to fill with the user sleection
      //
      ISingleDataGuiElement codeInput =(ISingleDataGuiElement) context.getGroup().findByName("taskEdvin_beh_code");
      ISingleDataGuiElement descInput =(ISingleDataGuiElement) context.getGroup().findByName("taskEdvin_beh_bez");
      ...
      String[][] col = Edvin.getBaueinheiten(edvin,hwg,code,desc);
      dialog.setData(col);
    ...
    {
      context.createMessageDialog("Kein Handwerkergrupper und/oder externes System definiert.").show();
    }
	}
