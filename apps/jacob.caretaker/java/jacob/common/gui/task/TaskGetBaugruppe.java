 ...
 *
 */
public  class TaskGetBaugruppe extends IButtonEventHandler
{
  static public final transient String RCS_ID = "$Id: TaskGetBaugruppe.java,v 1.2 2004/11/16 18:36:34 mike Exp $";
  ...
  /* 
    ...
    {   
      ...
      //
      ISingleDataGuiElement codeInput =(ISingleDataGuiElement) context.getGroup().findByName("taskEdvin_bgr_code");
      ISingleDataGuiElement descInput =(ISingleDataGuiElement) context.getGroup().findByName("taskEdvin_bgr_bez");
      ...
      dialog.setData(Edvin.getBaugruppe(edvin,hwg,code,desc));
