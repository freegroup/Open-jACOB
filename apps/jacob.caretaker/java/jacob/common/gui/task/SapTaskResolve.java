 ...
 * 
 * Created on Wed Aug 15 13:18:38 CEST 2007
 */
...
import jacob.common.gui.task.TaskSetResolved.TaskSetResolvedCallback;

import org.apache.commons.logging.Log;


/**
 * The event handler for the SapTaskResolve record selected button.<br>
 * The {@link onAction(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * Insert your custom code within this method.<br>
 * 
 * @author achim
 */
public class SapTaskResolve extends IButtonEventHandler 
{
