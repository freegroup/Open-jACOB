 ...
 *
 */
public  class TaskGetMassnahmencode extends IButtonEventHandler
{
  static public final transient String RCS_ID = "$Id: TaskGetMassnahmencode.java,v 1.2 2004/11/16 18:36:34 mike Exp $";
  ...
  /* 
    ...
    {   
      ...
      //
      ISingleDataGuiElement codeInput =(ISingleDataGuiElement) context.getGroup().findByName("taskEdvin_mah_code");
      ISingleDataGuiElement descInput =(ISingleDataGuiElement) context.getGroup().findByName("taskEdvin_mah_bez");
      ...
      dialog.setData(Edvin.getMassnahmencode(edvin,hwg,code,desc));
