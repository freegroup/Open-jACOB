 ...
 *
 */
public  class TaskGetBauteil extends IButtonEventHandler
{
  static public final transient String RCS_ID = "$Id: TaskGetBauteil.java,v 1.2 2004/11/16 18:36:34 mike Exp $";
  ...
  /* 
    ...
    {   
      ...
      //
      ISingleDataGuiElement codeInput =(ISingleDataGuiElement) context.getGroup().findByName("taskEdvin_btl_code");
      ISingleDataGuiElement descInput =(ISingleDataGuiElement) context.getGroup().findByName("taskEdvin_btl_bez");
      ...
      dialog.setData(Edvin.getBauteil(edvin,hwg,code,desc));
