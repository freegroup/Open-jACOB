...
public final class Sap_edvin_object
{
   private Sap_edvin_object(){}

   // the name of the table alias	 
   public final static String NAME = "sap_edvin_object";
	 
   // All field names of the table alias "sap_edvin_object"
   /** 
     required: true<br>
     type:     INTEGER<br>
   */
