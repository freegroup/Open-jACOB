...
public final class Faplisbuildpartobj
{
   private Faplisbuildpartobj(){}

   // the name of the table alias	 
   public final static String NAME = "faplisbuildpartobj";
	 
   // All field names of the table alias "faplisbuildpartobj"
   /** 
     required: true<br>
     type:     TEXT<br>
   */
