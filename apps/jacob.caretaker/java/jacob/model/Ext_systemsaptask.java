...
public final class Ext_systemsaptask
{
   private Ext_systemsaptask(){}

   // the name of the table alias	 
   public final static String NAME = "ext_systemsaptask";
	 
   // All field names of the table alias "ext_systemsaptask"
   /** 
     required: true<br>
     type:     INTEGER<br>
   */
