...
public final class Faplisbuilding
{
   private Faplisbuilding(){}

   // the name of the table alias	 
   public final static String NAME = "faplisbuilding";
	 
   // All field names of the table alias "faplisbuilding"
   /** 
     required: true<br>
     type:     TEXT<br>
   */
