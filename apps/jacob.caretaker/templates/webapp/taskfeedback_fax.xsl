			...
			<fo:page-sequence master-reference="simple" initial-page-number="1">
				...
				<fo:table   table-layout="fixed">
				      <fo:table-column column-width="3cm"/>
					   ...
					   <fo:table-cell>
					       ...
					       <xsl:text> SMC-Auftrag: </xsl:text><xsl:value-of select="./task/pkey" />
					       </fo:block>
					   </fo:table-cell>
                                       </fo:table-row>
				            </fo:table-body>
				...
				<fo:flow flow-name="xsl-region-body">
				                  ...
				                  <!-- 1 Zeile  -->
                                    ...
                                    <fo:table-row line-height="50pt">
					                  ...
					                  <fo:table-cell >
					                     ...
					                     <xsl:text>Der SMC Auftrag </xsl:text><xsl:value-of select="//task/pkey" /><xsl:text> wurde "</xsl:text><xsl:value-of select="./task/taskstatus" /><xsl:text>".</xsl:text>
							     </fo:block>
					               </fo:table-cell>
                                    </fo:table-row>
				                  <!-- Standardtext  -->
				    <fo:table-row line-height="12pt" >
					                  ...
					                  <fo:table-cell >
								<fo:block text-align="start" ><xsl:text>Sehr geehrte Auftragskoordinatorin,</xsl:text></fo:block>
					                  </fo:table-cell>
                                    </fo:table-row>
                                    <fo:table-row line-height="12pt" >
					                  <fo:table-cell>
					                  ...
					                  <fo:table-cell>
								<fo:block text-align="start" ><xsl:text>Sehr geehrter Auftragskoordinator,</xsl:text></fo:block>
					                  </fo:table-cell>
                                    </fo:table-row>
			            ...
			            <fo:table-row line-height="40pt" >
					                  ...
					                  <fo:table-cell>
								<fo:block text-align="start" ><xsl:text>Mit freundlichen Grüßen.</xsl:text></fo:block>
					                  </fo:table-cell>
                                    </fo:table-row>
			            <fo:table-row line-height="50pt" >
					                  <fo:table-cell>
