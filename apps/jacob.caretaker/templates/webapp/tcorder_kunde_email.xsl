...
<xsl:template match="/">
  <xsl:text>Terminbestätigung für Ihren Räderwechsel - </xsl:text><xsl:value-of select="./doc/data/tc_order/pkw"/>
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
  ...
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>Vielen Dank für Ihren Anruf zur Terminvereinbarung.</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>Ihre Anfrage läuft unter der Bearbeitungsnummer: </xsl:text>
  <xsl:value-of select="./doc/data/tc_order/call" />
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>Der Räderwechsel erfolgt für das Fahrzeug </xsl:text>
  ...
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>Wir bitten Sie, eine zeitliche Dauer von ca. 15 Minuten für den Räderwechsel einzuplanen.</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>Der Räderwechsel findet im Gebäude der Firma Formel D in Böblingen - Herrenberger Straße 120 - statt.</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>Eine Anfahrtsskizze entnehmen Sie bitte Ihrem Ankündigungsschreiben Sommer/Winterreifen Wechselaktion.</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
  <xsl:text>&#13;&#10;</xsl:text>
