 ...
 * 
 * Created on Tue Sep 06 12:14:46 CEST 2005
 *
 */
...
public class DefaultName extends IButtonEventHandler 
{
  ...
  {
    System.out.println("autoclose=false");
		IDataTableRecord currentRecord = context.getSelectedRecord();
    IRelationSet set = context.getApplicationDefinition().getDefaultRelationSet();
    
    IRecordTreeDialog dialog = context.createRecordTreeDialog(button, context.getSelectedRecord(),set,Filldirection.BOTH,new IRecordTreeDialogCallback()
    {
      public void onSelect(IClientContext context, IDataTableRecord arg1) throws Exception
      {
//        alert(((ClientContext)context).clientBrowser);
        context.setCurrentForm("document","incredencien");
        context.getDataAccessor().propagateRecord(arg1,Filldirection.BOTH);
      }
    });
