...
{
	static public final transient String RCS_ID = "$Id: AccountResetPasswordButton.java,v 1.1 2010-09-17 08:42:21 achim Exp $";
    ...
    try
    {
      ...
      trans.commit();
      alert("Kennwort wurde erfolgreich zurückgesetzt.");
    }
    finally
    {
      trans.close();
