 ...
 * 
 * Created on Thu Sep 16 16:48:10 CEST 2010
 */
...
/**
 * The event handler for the DocumentUnLockButton record selected button.<br>
 * The {@link onAction(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * Insert your custom code within this method.<br>
 * 
 * @author achim
 */
public class DocumentUnLockButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: DocumentUnLockButton.java,v 1.1 2010-09-17 08:42:23 achim Exp $";
    ...
    docrec.setValue(transaction, Document.locked, 0);
    docrec.setValue(transaction, Document.lockedsince, null);
    docrec.resetLinkedRecord(transaction, Editor.NAME);
    try
    {
      transaction.commit();
    }
