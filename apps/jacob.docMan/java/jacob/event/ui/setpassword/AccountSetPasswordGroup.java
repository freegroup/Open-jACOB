 ...
 * 
 * Created on Mon Jul 05 13:34:49 CEST 2010
 */
...
import jacob.model.Setpassword;
 ...
 * @author andherz
 */
 public class AccountSetPasswordGroup extends IGroupEventHandler 
 {
	static public final transient String RCS_ID = "$Id: AccountSetPasswordGroup.java,v 1.1 2010-09-17 08:42:24 achim Exp $";
  ...
  public void onShow(IClientContext context, IGroup group) throws Exception 
  {
    ...
    IDataTable userTable = context.getDataTable(Setpassword.NAME);
    userTable.qbeSetKeyValue(Setpassword.pkey, context.getUser().getKey());
    userTable.search();
  }
}
