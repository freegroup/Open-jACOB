...
{
	static public final transient String RCS_ID = "$Id: Application.java,v 1.1 2010-09-17 08:42:21 achim Exp $";
   ...
   */
	...
	{
	  RedirectManager.installForward(appDef,".*(/document).*", "/cmdenter?entry=Download&app=docMan");
  }
