 ...
 * 
 * Created on Tue Jul 13 14:28:34 CEST 2010
 */
...
/**
 * The event handler for the HistoryShowFolderInOverviewButton record selected button.<br>
 * The {@link onAction(IClientContext, IGuiElement)} will be called, if the user clicks on this button.<br>
 * Insert your custom code within this method.<br>
 * 
 * @author andherz
 */
public class HistoryShowFolderInOverviewButton extends IButtonEventHandler 
{
	static public final transient String RCS_ID = "$Id: HistoryShowFolderInOverviewButton.java,v 1.1 2010-09-17 08:42:25 achim Exp $";
    ...
    {
      alert("Ordner wurde zwischenzeitlich gelöscht");
    }
	}
