...
{
	static public final transient String RCS_ID = "$Id: RecyclebinRestoreDocumentButton.java,v 1.1 2010-09-17 08:42:24 achim Exp $";
	...
	public void onAction(IClientContext context, IGuiElement button) throws Exception
	{
	  IDataTransaction trans = context.getDataAccessor().newTransaction();
		...
		try
		{
		  ...
		  IDataTableRecord document = DocumentUtil.createDocument(context, trans, folder.getStringValue(Folder.pkey), data, name);
